...
init -1150 python:
    ...
    config.game_menu = [
        ...
        ( "preferences", u"Preferences", _intra_jumps("_prefs_screen", "intra_transition"), 'True' ),
        ...
        ( None, u"Main Menu", ui.callsinnewcontext("_main_menu_prompt"), 'not renpy.context().main_menu' ),
