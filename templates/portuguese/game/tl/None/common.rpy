translate None strings:
    ...
    old "Fast Skip Mode"
    new "Pular rapidamente"

    # renpy/common/00gltest.rpy:50
    old "Graphics Acceleration"
    new "Aceleração gráfico"
    ...
    new "Tem certeza que deseja deletar esse save?"

    # renpy/common/00layout.rpy:423
    old "Are you sure you want to overwrite your save?"
    new "Tem certeza que deseja sobreescrever esse save?"

    # renpy/common/00layout.rpy:424
    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "Carregar perderá todo progresso não salvo.\nTem certeza que quer fazer isso?"
    ...
    new "Tem certeza que deseja voltar ao menu principal?\nPerderá todo progresso não salvo."
    ...
    new "Forçar 'Software Renderer'"

    # renpy/common/00gltest.rpy:73
    old "Changes will take effect the next time this program is run."
    new "As mudanças serão salvas após renicialização do programa"

    # renpy/common/00gltest.rpy:112
    old "Performance Warning"
    new "Aviso de funcionamento"

    # renpy/common/00gltest.rpy:117
    old "This computer is using software rendering."
    new "Este computador usa 'software rendering'."
    ...
    new "Este computador mostrará gráficos lentamente"

    # renpy/common/00gltest.rpy:123
    old "This computer has a problem displaying graphics: [problem]."
    new "Este computador tem o seguinte problema gráfico: [problem]."

    # renpy/common/00gltest.rpy:128
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display. Updating DirectX could fix this problem."
    new "Os drivers gráficos podem estar desatualizados ou não funcionando adequadamente. Isso pode causar lentidão ou gráficos errôneos. Atualizar o DirectX pode resolver o problema."

    # renpy/common/00gltest.rpy:130
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Os drivers gráficos podem estar desatualizados ou não funcionando adequadamente. Isso pode causar lentidão ou gráficos errôneos."
    ...
    new "A instalação pela web do DirectX começou. Pode ser minimizada para a barra de tarefas. Siga as instruções para instalar o DirectX."

    # renpy/common/00gltest.rpy:179
    old "{b}Note:{/b} Microsoft's DirectX web setup program will, by default, install the Bing toolbar. If you do not want this toolbar, uncheck the appropriate box."
    new "{b}Nota:{/b} O programa de DirectX de Microsoft instalará, por padrão, instalará o Bing toolbar. Se não deseja essa toolbar, desative a opção correspondente."

    # renpy/common/00gltest.rpy:183
    old "When setup finishes, please click below to restart this program."
    new "Quando a instalação terminar, clique a baixo para reniciar o programa."
    ...
    new "Ignore a exceção e continue. Pode ocasionar mais erros."
    ...
    new "Recarrega o seu jogo do HD, salvando e restaurando o último jogo se possível."

    # renpy/common/_errorhandling.rpym:448
    old "Open Traceback"
    new "Abrir rastreamento"

    # renpy/common/_errorhandling.rpym:450
    old "Opens the traceback.txt file in a text editor."
    new "Abre o arquivo de rastreio 'traceback.txt' em um editor de texto."
    ...
    new "Erro em análise do código."

    # renpy/common/_errorhandling.rpym:510
    old "Open Parse Errors"
    new "Abrir errps de análise"

    # renpy/common/_errorhandling.rpym:512
    old "Opens the errors.txt file in a text editor."
    new "Abre o arquivo de erros, 'errors.txt', em um editor de texto."
    ...
    new "Preparando para baixar a atualização."

    # renpy/common/00updater.rpy:1273
    old "Downloading the updates."
    new "Baixando a atualização."

    # renpy/common/00updater.rpy:1275
    old "Unpacking the updates."
    new "Extraindo a atualização."
    ...
    new "A atualização foi instalada. O programa irá reniciar."

    # renpy/common/00updater.rpy:1281
    old "The updates have been installed."
    new "A atualização foi instalada."

    # renpy/common/00updater.rpy:1283
    old "The updates were cancelled."
    new "A atualização foi cancelada."
    ...
    new "Certeza que deseja entrar no modo pular?"

    # renpy/common/00layout.rpy:428
    old "Are you sure you want to skip to the next choice?"
    new "Você deseja pular a próxima escolha?"

    # renpy/common/00layout.rpy:429
    old "Are you sure you want to skip to unseen dialogue or the next choice?"
    new "Certeza que deseja pular o diálogo não visto ou a próxima escolha?"
    ...
    new "        (Não há propriedades que afetem essa visualização)"

    # renpy/common/_developer/inspector.rpym:126
    old "        (default properties omitted)"
    new "        (propiedades padrão foram omitidas)"
    ...
    new "Right-click ou ESC para sair."
    ...
    new "Nenhuma variável mudou desde o ínicio do jogo."

    # renpy/common/_developer/developer.rpym:125
    old "Return to the developer menu"
    new "Voltar para o menu do desenvolvedor"
    ...
    new " <sentença renpy script>: executa essa sentença\n"

    # renpy/common/00console.rpy:409
    old " <python expression or statement>: run the expression or statement"
    new " <expressão ou sentença python>: executa a expressão ou sentença"
    ...
    new "unwatchall: para de observar todas as expressões"
