...
translate piglatin simple_displayables_db46fd25:

    # e "Ren'Py has the concept of a displayable, which is something like an image that can be shown and hidden."
    e "Enray'Ypay ashay hetay onceptcay ofay aay isplayableday, hichway isay omethingsay ikelay anay imageay hattay ancay ebay ownshay anday iddenhay."

# game/indepth_displayables.rpy:22
translate piglatin simple_displayables_bfe78cb7:

    # e "The image statement is used to give an image name to a displayable. The easy way is to simply give an image filename."
    e "Hetay imageay atementstay isay useday otay ivegay anay imageay amenay otay aay isplayableday. Hetay easyay ayway isay otay implysay ivegay anay imageay ilenamefay."

# game/indepth_displayables.rpy:29
translate piglatin simple_displayables_cef4598b:
    ...
    e "Utbay hattay'say otnay hetay onlyay hingtay hattay anay imageay ancay eferray otay. Henway hetay ringstay oesnday'tay avehay aay otday inay itay, Enray'Ypay interpretsay hattay asay aay eferenceray otay aay econdsay imageay."

# game/indepth_displayables.rpy:41
translate piglatin simple_displayables_a661fb63:

    # e "The string can also contain a color code, consisting of hexadecimal digits, just like the colors used by web browsers."
    e "Hetay ringstay ancay alsoay ontaincay aay olorcay odecay, onsistingcay ofay exadecimalhay igitsday, ustjay ikelay hetay olorscay useday ybay ebway owsersbray."

# game/indepth_displayables.rpy:43
translate piglatin simple_displayables_7f2efb23:
    ...
    e "Hreetay oray ixsay igitday olorscay areay opaqueay, ontainingcay edray, eengray, anday ueblay aluesvay. Hetay ourfay anday eightay igitday ersionsvay appenday alphaay, allowingay anslucenttray olorscay."

# game/indepth_displayables.rpy:53
translate piglatin simple_displayables_9cd108c6:

    # e "The Transform displayable takes a displayable and can apply transform properties to it."
    e "Hetay Ransformtay isplayableday akestay aay isplayableday anday ancay applyay ansformtray ropertiespay otay itay."

# game/indepth_displayables.rpy:55
translate piglatin simple_displayables_a313a959:

    # e "Notice how, since it takes a displayable, it can take another image. In face, it can take any displayable defined here."
    e "Oticenay owhay, incesay itay akestay aay isplayableday, itay ancay aketay anotheray imageay. Niay acefay, itay ancay aketay anyay isplayableday efinedday erehay."

# game/indepth_displayables.rpy:63
translate piglatin simple_displayables_c6e39078:
...
translate piglatin simple_displayables_0befbee0:
    ...
    e "Histay eansmay hattay eway ancay applyay otheray isplayablesday, ikelay Ransformtay, otay Exttay inay hetay amesay ayway eway oday otay imagesay."

# game/indepth_displayables.rpy:91
translate piglatin simple_displayables_fcf2325f:
...
translate piglatin simple_displayables_3dc0050e:
    ...
    e "Omesay isplayablesday areay oftenay useday otay ustomizecay hetay Enray'Ypay interfaceay, ithway hetay Ramefay isplayableday eingbay oneay ofay hemtay. Hetay amefray isplayableday akestay anotheray isplayableday, anday hetay izesay ofay hetay eftlay, optay, ightray, anday ottombay ordersbay."

# game/indepth_displayables.rpy:111
translate piglatin simple_displayables_801b7910:
    ...
    e "Hetay Ramefay isplayableday expandsay oray rinksshay otay itfay hetay areaay availableay otay itay. Tiay oesday histay ybay calingsay hetay entercay inay wotay imensionsday anday hetay idessay inay oneay, hileway eepingkay hetay ornerscay hetay amesay izesay."

# game/indepth_displayables.rpy:118
translate piglatin simple_displayables_00603985:

    # e "A Frame can also tile sections of the displayable supplied to it, rather than scaling."
    e "Aay Ramefay ancay alsoay iletay ectionssay ofay hetay isplayableday uppliedsay otay itay, atherray hantay calingsay."

# game/indepth_displayables.rpy:126
translate piglatin simple_displayables_d8b23480:
    ...
    e "Ramesfay ightmay ooklay aay ittlelay eirdway inay hetay abstractay, utbay henway useday ithway aay exturetay, ouyay ancay eesay owhay eway reatecay calablesay interfaceay omponentscay."

# game/indepth_displayables.rpy:132
translate piglatin simple_displayables_ae3f35f5:

    # e "These are just the simplest displayables, the ones you'll use directly the most often."
    e "Hesetay areay ustjay hetay implestsay isplayablesday, hetay onesay ouyay'llay useay irectlyday hetay ostmay oftenay."

# game/indepth_displayables.rpy:134
translate piglatin simple_displayables_de555a92:
    ...
    e "Ouyay ancay evenay riteway ustomcay isplayablesday orfay inigamesmay, ifay ouyay'eray roficientpay atay Ythonpay. Utbay orfay anymay isualvay ovelsnay, hesetay illway ebay allay ouyay'llay eednay."
