...
translate korean tutorial_playing_2985ab86:
    ...
    e "다른 몇몇 비주얼 노벨들을 플레이해본 사람이라면 비주얼 노벨이 가져야할 몇가지 중요한 기능들을 예상할 수 있겠죠?"
...
translate korean tutorial_playing_ca4769bb:
    ...
    e "저장을 하는 기능이나, 로드를 하는 기능이라던가, 설정을 바꾸는 기능 등등 말이에요."
...
translate korean tutorial_playing_f30f1979:
    ...
    e "다행히도 렌'파이 엔진은 이런 기능의 대부분을 지원해 준답니다. 여러분이 게임을 만들 동안, 이런 기능은 렌'파이 엔진에게 맡겨주세요!"
...
translate korean tutorial_playing_afa743e7:
    ...
    e "게임을 플레이하고 있을 때, 마우스 오른쪽 클릭이나 Esc버튼을 누르면 게임 메뉴를 보실 수 있습니다."
...
translate korean tutorial_playing_8360224a:
    ...
    e "게임 메뉴에 첫번째로 들어가면 저장 스크린을 보실 수 있을 거예요. 번호가 매겨진 슬롯을 클릭하면 게임이 그 슬롯에 저장됩니다."


# game/tutorial_playing.rpy:30
translate korean tutorial_playing_6d0ef6c9:


    # e "Unlike other engines, Ren'Py doesn't limit the number of save slots that you can use."
    e "다른 엔진과는 다르게, 렌'파이는 사용할 수 있는 슬롯의 개수가 무제한이랍니다!"
...
translate korean tutorial_playing_fea05c6b:
    ...
    e "로드 스크린은 저장 스크린과 비슷하게 생겼는데요, 저장 슬롯에서 게임을 로드할 수 있도록 해준답니다."
...
translate korean tutorial_playing_8e7e83a8:
    ...
    e "또한, 렌'파이가 여러분께 제공하는 자동 저장에서 불러올 수도 있어요."


# game/tutorial_playing.rpy:39
translate korean tutorial_playing_2bad7992:


    # e "The other screen of the game menu is the preferences screen."
    e "게임 메뉴의 다른 스크린은 설정 스크린입니다."
...
translate korean tutorial_playing_eaac8ba9:
    ...
    e "이 스크린은 여러분이 렌'파이의 화면 모드나, 스킵을 할 것을 선택한다던가, 대사가 나타나는 속도, 자동 넘기기 속도를 조정할 수 있습니다. 음악, 더빙의 음량도 이 스크린에서 조정합니다."
...
translate korean tutorial_playing_b1562a34:
    ...
    e "게임 메뉴에서는 게임을 종료하고 메인 화면으로 돌아가거나 게임을 완전히 종료시킬 수도 있습니다."
...
translate korean tutorial_playing_790f9dc7:
    ...
    e "만약 기본 게임 메뉴가 살짝 식상해 보이신다면, 약간의 작업으로 커스터마이징하거나 아예 완전히 색다르게 바꿔버릴 수도 있어요."
...
translate korean tutorial_playing_bc29822e:
    ...
    e "게임을 플레이하면서 할 수 있는 일은 몇가지 더 있습니다."
...
translate korean tutorial_playing_dc0f9cf7:
    ...
    e "엔딩을 전부 보고 싶을때, 렌'파이의 스킵 기능은 이미 봤던 대사를 스킵함으로써 다른 엔딩을 쉽게 볼 수 있어요."


# game/tutorial_playing.rpy:58
translate korean tutorial_playing_6dded697:


    # e "I can skip a few lines by holding down Control, or I can toggle skip mode by pressing tab."
    e "Ctrl키를 누르거나 Tab키를 통해 몇 줄을 건너뛸 수 있습니다."
...
translate korean tutorial_playing_d3553fbe:
    ...
    e "기본값으로 렌'파이는 이미 한번 읽었던 지문만을 건너 뛰기 때문에, 처음 읽는 것이라면 아무런 동작도 하지 않아요."


# game/tutorial_playing.rpy:62
translate korean tutorial_playing_9a605016:
    ...
    e "'S'키는 스크린샷을 찍어 컴퓨터에 저장해서 {a=http://www.renpy.org}renpy.org{/a}같은 웹사이트에 업로드 할 수 있답니다.. "


# game/tutorial_playing.rpy:64
translate korean tutorial_playing_a9c70134:


    # e "Finally, there's rollback, which lets you go back in time to previous screens, letting you re-read text."
    e "마지막으로, 롤백이 있습니다. 이것은 이전 대사로 돌아가서 다시 한번 읽을 수 있게 해 줍니다."


# game/tutorial_playing.rpy:65
translate korean tutorial_playing_ffcaf528:


    # e "Would you like to hear more about rollback?" nointeract
    e "롤백에 대해 조금 더 들어보실래요?" nointeract


# game/tutorial_playing.rpy:80
translate korean tutorial_rollback_40b09eaf:
    ...
    e "마우스 스크롤을 내리거나 Page Up키를 눌러서 롤백 할 수 있습니다. 여러분을 이전 대사로 돌아가게 해 드릴 겁니다."
...
translate korean tutorial_rollback_041be71b:
    ...
    e "이전 스크린에서 마우스 스크롤을 올리거나 Page Down 키를 누르면 다시 앞으로 진행할 수 있습니다."


# game/tutorial_playing.rpy:84
translate korean tutorial_rollback_1d0e55c3:
    ...
    e "앞으로 진행할 때 선택지를 지나친다면 이전과 같은 선택을 하지만, 다른 엔진과는 달리 렌'파이는 롤백해서 새로운 선택지를 고르는 것이 가능합니다."
...
translate korean tutorial_rollback_a4633f53:
    ...
    e "지금 롤백해서 이전 선택지로 돌아간 후, '아뇨'를 선택해 보실 수 있어요."


# game/tutorial_playing.rpy:88
translate korean tutorial_rollback_a30f8a06:


    # e "Press page up, or scroll up the mouse wheel."
    e "Page Up을 누르거나 스크롤을 올려 보세요."
...
translate korean tutorial_rollback_done_54d6ee45:
    ...
    e "렌'파이가 게임 외 기능들(저장하기, 로드하기 등)을 작업하게 해 주세요! 여러분은 여러분의 게임에 집중하실 수 있습니다!"