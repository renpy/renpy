...
translate korean tutorial_playing_ca4769bb:
    ...
    e "대화를 하거나, 불러오고, 설정을 변경하는 등의 기능들 말야."

# game/tutorial_playing.rpy:15
translate korean tutorial_playing_f30f1979:
    ...
    e "렌파이의 좋은 점 중 하나는 이러한 많은 기능들을 기본적으로 제공한다는 거야. 게임을 제작할 때 우리가 제공하는 것들로 시간을 절약할 수 있어."

# game/tutorial_playing.rpy:17
translate korean tutorial_playing_afa743e7:

    # e "While you're in the game, you can access the game menu by right clicking or hitting the escape key."
    e "게임을 하는 동안, 마우스 오른쪽 버튼을 클릭하거나 이스케이프(Escape, Esc) 키를 눌러 게임 메뉴에 진입할 수 있어."

# game/tutorial_playing.rpy:19
translate korean tutorial_playing_1a6c8296:

    # e "You can also access the game menu through some of the quick menu buttons at the bottom of this screen."
    e "또한 화면 아래쪽에 있는 빠른 메뉴(Quick menu) 버튼을 통해서도 게임 메뉴에 진입할 수 있어."

# game/tutorial_playing.rpy:25
translate korean tutorial_playing_8360224a:

    # e "When you first enter the game menu, you'll see the save screen. Clicking on a numbered slot will save the game."
    e "처음 게임 메뉴에 들어가면 저장 화면을 보게 돼. 번호가 매겨진 슬롯을 클릭하면 게임이 저장되고."

# game/tutorial_playing.rpy:27
translate korean tutorial_playing_edea14ff:
...
translate korean tutorial_playing_eaac8ba9:
    ...
    e "이 화면은 렌파이가 화면을 어떻게 보여줄지, 어떤 것을 넘기고, 글자 속도와 자동 진행 속도를 조절하고, 효과음과 음악, 음성 크기를 어느 정도로 할 지를 설정할 수 있어."

# game/tutorial_playing.rpy:42
translate korean tutorial_playing_b1562a34:

    # e "The game menu also lets you end the game and return to the main menu, or quit Ren'Py entirely."
    e "게임 메뉴에는 대문으로 돌아가거나 렌파이를 종료하는 기능도 있어."
...
translate korean tutorial_playing_bc29822e:
    ...
    e "게임 내에서 할 수 있는 일은 몇 가지가 더 있는데,"
...
translate korean tutorial_playing_73f3cfec:
    ...
    e "대사록 버튼을 누르면 이미 읽은 글자들을 화면에 보여줘. 되감기를 사용할 수도 있지만 일반적으로 더 좋을 거야."

# game/tutorial_playing.rpy:69
translate korean tutorial_playing_f065a34c:

    # e "Would you like to hear about rollback?" nointeract
    e "되감기에 대해 들어볼래?" nointeract

# game/tutorial_playing.rpy:84
translate korean tutorial_rollback_a520091b:
    ...
    e "'되감기'버튼을 클릭하거나, 마우스 휠을 위로 올리거나, 페이지업(Page up, PgUp) 키를 눌러 되감기를 호출할 수 있어. 그러면 이전 화면으로 돌아가지."

# game/tutorial_playing.rpy:86
translate korean tutorial_rollback_041be71b:

    # e "While at a previous screen, you can roll forward by scrolling the mouse wheel down, or pushing the page down key."
    e "이전 화면에서는, 마우스 휠을 아래로 내리거나 페이지 다운(Page down, PgDn) 키를 눌러 다시 앞으로 진행(롤 포워드)시킬 수 있어."

# game/tutorial_playing.rpy:88
translate korean tutorial_rollback_4b903465:
    ...
    e "메뉴를 롤 포워드하면 마지막으로 선택한 것과 동일한 선택을 해. 하지만 렌파이의 되감기 시스템은 다른 선택을 할 수 있게 해주니까 굳이 사용하지 않아도 돼."

# game/tutorial_playing.rpy:90
translate korean tutorial_rollback_a4633f53:

    # e "You can try it by rolling back through the last menu, and saying 'No'."
    e "마지막 메뉴를 롤백하고 '아니오'라고 말하면 다시 시도할 수 있어."

# game/tutorial_playing.rpy:92
translate korean tutorial_rollback_5b73f822:

    # e "Click back a few times, press page up, or scroll up the mouse wheel."
    e "몇 번 되감기를 클릭하거나 페이지 업(Page up, PgUp)을 누르거나 마우스 휠을 위로 올려봐."
...
translate korean tutorial_rollback_dce979d4:

    # e "Moving on."
    e "계속해."

# game/tutorial_playing.rpy:106
translate korean tutorial_rollback_done_6564cd32:
    ...
    e "렌파이가 저장 및 불러오기 같은 게임 밖의 문제를 처리하도록 허용함으로써 시각 소설을 플레이할 때 기대했던 경험을 플레이어에게 제공하고, 너는 게임 제작에 집중할 수 있어."
