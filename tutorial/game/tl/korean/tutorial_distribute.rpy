...
translate korean distribute_d373903b:
    ...
    e "배포판을 만들기 전에, 우리는 반드시 '스크립트 확인(오류 검사)' 명령을 사용해서 게임에 문제가 있는지 확인해야 해."
...
translate korean distribute_638f964a:
    ...
    e "매킨토시를 사용한다면, 플레이어가 쉽게 게임을 실행할 수 있도록 Mac 애플리케이션 서명을 가지고 있어야 해. 이것을 활성화하려면, options.rpy에서 build.mac_identity를 설정해야 해."
...
translate korean distribute_0b547b7b:
    ...
    e "이러한 모바일 플랫폼들은 조금 더 복잡할 수 있어. 안드로이드 앱은 어디서나 제작할 수 있지만 iOS는 Mac이 필요해."
...
translate korean distribute_a9a2149f:
    ...
    e "모바일을 여기서 다루기 보다는, 우리의 {a=https://www.renpy.org/doc/html/android.html}안드로이드{/a}와 {a=https://www.renpy.org/doc/html/ios.html}iOS{/a} 지원 문서를 참조하는 것이 좋을 것 같아."
