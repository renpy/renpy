...
translate korean pong_done_750092ed:
    ...
    e "그것에 대해서는 자세히 다루지 않을 거야. {a=https://www.renpy.org/doc/html/udd.html}창작자-정의 디스플레이어블{/a}은 문서에서 더 읽어볼 수 있어."
