...
translate korean demo_text_6d050f89:
    ...
    e "커닝 태그는 글자 사이의 간격을 조정합니다.\n{k=1}글자 간격을 늘리거나{/k}\n{k=-1}글자 간격을 줄일 수도 있죠.{/k}"


# game/demo_text.rpy:90
translate korean demo_text_e8835287:


    # eruby "You are able to write ruby text, which can help clarify how to pronounce words, like {rb}Ren'Py{/rb}{rt}ren-pie{/rt}."
    eruby "루비 텍스트도 사용이 가능합니다! 이러한 루비 텍스트는 단어의 발음을 확실히 할 때 사용될 수 있습니다. {rb}Ren'Py{/rb}{rt}렌'파이{/rt}처럼요."


# game/demo_text.rpy:92
translate korean demo_text_6e1b95f0:


    # e "{a=define_hyperlink}Hyperlinks{/a} let buttons be defined using text tags."
    e "{a=define_hyperlink}하이퍼링크{/a}는 텍스트 태그를 이용해서 버튼을 정의할 수 있게 해 줍니다."


# game/demo_text.rpy:94
translate korean demo_text_245e745a:


    # e "The space and vspace tags add {space=30} horizontal and {vspace=20}vertical space, respectively."
    e "space 태그는 {space=30} 가로로, vspace 태그는 {vspace=20}세로로 공백을 추가합니다."


# game/demo_text.rpy:96
translate korean demo_text_362f67bb:
...
translate korean demo_text_2a8833c0:
    ...
    esfont "SFonts let you use fonts you otherwise couldn't, and apply special effects to fonts using your favorite image editor."
    e "{size=-4}SFonts는 특별한 툴 없이 여러분이 좋아하는 이미지 에디터로 글자에 효과를 줄 수 있어요.{/size}"


# game/demo_text.rpy:130
translate korean demo_text_418ffc27:


    # e "Well, that's it for fonts and text tags."
    e "음, 폰트와 텍스트 태그에 관해서는 이게 다예요."


# game/demo_text.rpy:138
translate korean define_hyperlink_8863ed04:
    ...
    definition "하이퍼링크는 텍스트 태그를 사용하여 텍스트 안에 정의된 버튼입니다. 스크립트 안의 단어의 뜻을 설명할 때 유용히 사용됩니다. 하지만, 선택지 메뉴 안에서 사용하면 안 됩니다."