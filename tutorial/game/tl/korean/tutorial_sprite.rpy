...
translate korean tutorial_sprite_d2ca6a0c:
    ...
    e "렌'파이는 스프라이트 시스템을 지원합니다. 이는 비슷한 물건들을 한번에 스크린 위에 올릴 수 있게 하는 시스템인데요. "


# game/tutorial_sprite.rpy:70
translate korean tutorial_sprite_40df8d5d:
    ...
    e "제 뒤의 배경에는 175개의 별들이 날아다니고 있는데요, 각각 조금씩 다른 속도로 날아다니기 때문에 성간 비행 효과를 낼 수 있죠."


# game/tutorial_sprite.rpy:72
translate korean tutorial_sprite_29c5e523:
    ...
    e "이런 식으로 부드럽게 움직이기 위해서는 OpenGL 시스템을 사용할 수 있어야 합니다. 만약 소프트웨어를 사용한다면 별들이 살짝 버벅이면서 날아갈 수도 있어요."


# game/tutorial_sprite.rpy:74
translate korean tutorial_sprite_90927173:


    # e "You'll need to decide which older systems to support."
    e "여러분은 게임을 만들기 전에 얼마나 오래된 시스템까지 지원할 것인지 결정해야 해요."


# game/tutorial_sprite.rpy:80
translate korean tutorial_sprite_9afa1448:


    # e "The sprite manager requires you to write a python function to move the sprites around."
    e "스프라이트 매니저는 스프라이트들이 어디로 움직여야 하는지 알려주는 파이썬 함수를 요구합니다."


# game/tutorial_sprite.rpy:84
translate korean tutorial_sprite_2c9a79ad:


    # e "In many cases, all you need is something moving around the screen - like cherry blossoms, or snow."
    e "많은 경우, 벚꽃 꽃잎이나 눈꽃과 같이 스크린 주위에서 흩날리는 것이 필요한 경우가 대다수죠."


# game/tutorial_sprite.rpy:86
translate korean tutorial_sprite_595d03b3:


    # e "That's what the snowblossom function gives you - a simple way to have things falling from the top of the screen."
    e "그리고 그러한 동작은 snowblossom 함수로 쉽게 해결할 수 있어요. 이 함수는 화면의 상단에서 떨어지는 동작을 나타냅니다."


# game/tutorial_sprite.rpy:91
translate korean tutorial_sprite_4f82c848:


    # e "And that's it for sprites."
    e "스프라이트에 관한 설명은 여기까지입니다."