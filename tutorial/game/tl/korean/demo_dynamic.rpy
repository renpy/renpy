...
translate korean demo_dynamic_b72548ea:
    ...
    e "DynamicDisplayable 함수는 상호 작용의 과정에 따라 보여질 디스플레이어블을 다르게 할 수 있습니다."


# game/demo_dynamic.rpy:31
translate korean demo_dynamic_0276dbb9:


    # e "This makes it possible to display things like countdown timers and progress bars."
    e "이는 카운트다운 타이머나 상태 진행 바와 같은 것을 만들 수 있게 할 수 있죠."


# game/demo_dynamic.rpy:33
translate korean demo_dynamic_4cabf539:
    ...
    e "기억하세요. 사람들은 제각각 읽는 속도가 다릅니다. 그러니 게임을 시간에 맞춰 제작하기 보다는 이 기능을 그냥 게임에 멋을 주는 용도로 사용하는 것이 나을지도 모릅니다."