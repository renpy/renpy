...
translate korean demo_minigame_03fc91ef:
    ...
    e "렌'파이와 다른 종류의 게임을 섞어 보고 싶은 사람도 있을 거예요. 나쁘지 않아요. 그래서 렌'파이는 이를 실현시킬 여러가지 방법들을 제공합니다."


# game/demo_minigame.rpy:206
translate korean demo_minigame_8c389a44:


    # e "The first is with the UI functions, which can be used to create powerful button and menu based interfaces."
    e "첫번째 방법은 UI 함수를 사용하는 것인데요, 버튼과 선택지 기반의 인터페이스를 만드는 강력한 방법 중 하나입니다."


# game/demo_minigame.rpy:208
translate korean demo_minigame_0d5698fc:


    # e "These are often enough for many simulation-style games."
    e "시뮬레이션 타입의 게임이라면 UI 함수만으로도 충분히 만족스러운 결과를 만들 수 있어요."


# game/demo_minigame.rpy:210
translate korean demo_minigame_abc48e39:
...
translate korean demo_minigame_pong_68c82e98:
...
translate korean demo_minigame_pong_dde7e31a:


    # e "Would you like to play again?" nointeract
    e "한번 더 플레이 하실래요?" nointeract


# game/demo_minigame.rpy:264
translate korean demo_minigame_pong_cd12159e:
    ...
    e "여러분의 비주얼 노벨에 미니게임을 넣을 때는 조금 생각을 해 보시는게 좋아요. 모든 비주얼 노벨 플레이어가 아케이드 게임 마스터가 되기를 원하지는 않으니까요."
