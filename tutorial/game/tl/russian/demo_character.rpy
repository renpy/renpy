...
translate russian demo_character_16897d85:
    ...
    e "Объект Character используется для объявления персонажей, и его также можно настраивать для изменения вида речи персонажа."

# game/demo_character.rpy:47
translate russian demo_character_7ad48073:

    # e "By supplying it with the appropriate arguments, we can really change around the feel of the game."
    e "Используя правильные аргументы с этим объектом, можно сильно изменить внешний вид игры."

# game/demo_character.rpy:49
translate russian demo_character_6fc5bef5:

    # e "In this section, we'll demonstrate some of what can be accomplished by customizing character objects."
    e "В этом разделе мы покажем некоторые вещи, которых можно достичь, настраивая объекты Character."

# game/demo_character.rpy:51
translate russian demo_character_2edcd1df:
    ...
    equote "Предоставляя аргументы what_prefix и what_suffix объекту Character, мы можем добавлять знаки до и после каждой строки текста."

# game/demo_character.rpy:53
translate russian demo_character_3ba649df:

    # equote "This is a lot easier than having to put those quotes in by hand."
    equote "Это намного проще, чем печатать лишние кавычки вручную."

# game/demo_character.rpy:55
translate russian demo_character_48dc5333:

    # equote "We can also use who_prefix and who_suffix to add text to the name of the speaker."
    equote "Мы также можем использовать who_prefix и who_suffix для добавления текста к имени персонажа."

# game/demo_character.rpy:57
translate russian demo_character_77ce5256:
    ...
    e "Мы также можем добавлять аргументы к объекту Character изменяющие вид имени, текста и самого окна."

# game/demo_character.rpy:59
translate russian demo_character_fceb39fb:

    # eweird "These can really change the look of the game."
    eweird "Это может изменить вид игры."
...
translate russian demo_character_ba09ee13:
    ...
    etwo "Также существует show_two_window, который размещает имя персонажа в отдельное окно."
...
translate russian demo_character_90e5383f:
    ...
    ectcf "Изображение для такого индикатора также можно разместить на фиксированном положении экрана."

# game/demo_character.rpy:69
translate russian demo_character_4a210bad:

    # e "There's a lot more you can do with Character, as it lets you set style properties on all of the displayed text."
    e "С классом Character можно делать много разных вещей, так как он позволяет вам настроить внешний вид всего отображаемого текста."
...
translate russian demo_character_29688b7c:
    ...
    centered "Персонаж \"centered\" показывает текст посередине экрана без окна."
...
translate russian demo_character_e79e9042:
    ...
    e "Персонаж \"extend\" очень особый."

# game/demo_character.rpy:85
translate russian demo_character_0b55b872:

    # e "It lets you"
    e "Он позволяет"

# game/demo_character.rpy:89
translate russian demo_character_7c80c8fc:

    # extend " extend the previous dialogue"
    extend " расширить предыдущую строку диалога"

# game/demo_character.rpy:93
translate russian demo_character_645bb443:

    # extend " with additional text."
    extend " дополнительным текстом."

# game/demo_character.rpy:95
translate russian demo_character_170d938b:

    # e "That lets you have things happen in the middle of text. If you didn't notice, I was changing my expression."
    e "Это позволяет вам делать различные вещи во время разговора персонажа. Если вы не заметили, я меняла выражение лица."
