...
translate russian strings:
    ...
    new "Ввод текста и интерполяция"
    ...
    new "Инструменты и Интерактивный Директор"

    # script.rpy:70
    old "Building Distributions"
    new "Постройка дистрибутивов"

    # script.rpy:72
    old "In Depth"
    new "Расширенный курс"

    # script.rpy:74
    old "Text Tags, Escapes, and Interpolation"
    new "Текстовые теги, Разрывы и Интерполяция"
    ...
    new "Позиционные параметры"

    # script.rpy:83
    old "Transforms and Animation"
    new "Анимация и Трансформация"

    # script.rpy:84
    old "Transform Properties"
    new "Параметры трансформаций"
    ...
    new "Что бы вы хотели посмотреть?"

    # script.rpy:170
    old "Is there anything else you'd like to see?"
    new "Хотите ли вы посмотреть что-то ещё?"
