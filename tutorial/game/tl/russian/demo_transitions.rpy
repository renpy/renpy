...
translate russian demo_transitions_5bbc72fe:
    ...
    e "Ren'Py предоставляет множество встроенных переходов и классы, позволяющие вам определять свои собственные."
...
translate russian demo_transitions_menu_3caf78d3:
    ...
    e "Какие переходы вы хотите продемонстрировать?" nointeract
...
translate russian demo_simple_transitions_4b235ac2:
    ...
    e "Но не бойтесь. В играх вы скорее всего будете использовать чаще всего именно их."
...
translate russian demo_simple_transitions_f059f4ae:
    ...
    e "Вы можете использовать функцию 'Fade' для создания своих аналогов. Вы можете изменять время и цвет."
    e "Это позволит вам даже создавать спецэффекты, вроде моргающих лампочек."
...
translate russian demo_simple_transitions_e948905b:
    ...
    e "Переход 'pixellate' преобразует старую сцену в пиксели, переходит на новую, и затем показывает её."
...
translate russian demo_simple_transitions_6a1ae05f:
    ...
    e "Для большинства игр она не будет сильно полезной, но мы думаем, что это выглядит прикольно."
...
translate russian demo_simple_transitions_51c1c5b8:
    ...
    e "Я хотела показать 'vpunch'... Ну, я уже показала."
...
translate russian demo_simple_transitions_57f19473:
    ...
    e "Экран можно также трясти горизонтально, используя 'hpunch'. Они были определены функцией 'Move'."
...
translate russian demo_simple_transitions_fbb1838e:
    ...
    e "Наконец, есть 'Pause', который позволяет приостановить игру на некоторое время."

# game/demo_transitions.rpy:145
translate russian demo_simple_transitions_654a7a87:

    # e "Why would you want to do that?"
    e "Почему?"

# game/demo_transitions.rpy:147
translate russian demo_simple_transitions_3b8c0bce:

    # e "It's because clicking during a sequence of transitions will skip all of the remaining transitions."
    e "Потому, что щелчок кнопкой мыши во время переходов пропустит все оставшиеся."
...
translate russian demo_simple_transitions_c75a0d2d:
    ...
    e "Использование 'Pause' позволяет легко создавать пропускаемые заставки."
...
translate russian demo_imagedissolve_transitions_12e2e0d0:
    ...
    e "Переход 'squares' использует эти квадраты для отображения вещей."
...
translate russian demo_imagedissolve_transitions_ee427486:
    ...
    e "Переход 'circlewipe' изменяет экраны используя эффект круглого стирания."
...
translate russian demo_imagedissolve_transitions_c0b9d74d:
    ...
    e "Переход 'teleport' показывает новую сцену по одной строчке за раз."
...
translate russian demo_imagedissolve_transitions_4b557a29:
    ...
    e "... что позволило нам применить эффект телепортации к одному персонажу."

# game/demo_transitions.rpy:257
translate russian demo_imagedissolve_transitions_e16f8d3a:

    # e "For more examples of ImageDissolve, check out the {i}Utsukushii Effects{/i} demo."
    e "Для того, чтобы увидеть больше примеров ImageDissolve, посмотрите на демо {i}Utsukushii Effects{/i}."
...
translate russian demo_cropmove_transitions_1711a91e:
    ...
    e "Класс переходов CropMove представляет широкий набор эффектов. Но его редко используют в практике."
...
translate russian demo_movetransition_5edf6007:
    ...
    e "Переходы movein (moveinleft, moveinright, moveintop и moveinbottom) втаскивают новые изображения."
...
translate russian demo_movetransition_af4c53cf:
    ...
    e "Наконец, есть переходы zoomin и zoomout, которые показывают и прячут изображения используя масштабирование."
