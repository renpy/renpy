...
translate russian tutorial_nvlmode_e7030787:
...
translate russian tutorial_nvlmode_c9a35125:
...
translate russian tutorial_nvlmode_130610c2:
...
translate russian tutorial_nvlmode_390a4eb1:
...
translate russian tutorial_nvlmode_05956e33:
    ...
    nvle "Режим NVL также поддерживает показ меню игроку с условием, что меню будет показано последним на экране. Понятно?" nointeract

# game/tutorial_nvlmode.rpy:54
translate russian tutorial_nvlmode_0f2b7d59:
...
translate russian tutorial_nvlmode_f3a79c09:

    # nvl clear
    # nvle "Well, hopefully the code below makes it a little more clear."
    nvl clear
    nvle "Ну, надеюсь, хотя бы код ниже поможет вам всё понять."

# game/tutorial_nvlmode.rpy:69
translate russian after_nvl_menu_cb560cd2:

    # nvle "Games can mix NVL-mode and the normal ADV-mode by having some characters that have kind=nvl, and some that do not."
    nvle "Игры могут использовать смешанный NVL-ADV режим, при котором некоторые персонажи будут подвида kind=nvl, а другие обычные."

# game/tutorial_nvlmode.rpy:71
translate russian after_nvl_menu_10a6e85a:

    # e "You can specify transitions that occur when going from NVL-mode to ADV-mode."
    e "Вы можете настроить переходы из NVL-режима в ADV…"

# game/tutorial_nvlmode.rpy:73
translate russian after_nvl_menu_d43b28d1:

    # nvle "As well as when going from ADV-mode to NVL-mode."
    nvle "И в NVL, соответственно."

# game/tutorial_nvlmode.rpy:75
translate russian after_nvl_menu_f056c7ad:
