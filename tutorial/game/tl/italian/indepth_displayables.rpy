...
translate italian simple_displayables_db46fd25:
    ...
    # e "Ren'Py has a concept of a displayable, which is something like an image that can be shown and hidden."
    e "Ren'Py prevede il concetto di displayable, ovvero un elemento simile a un'immagine che può essere visualizzato o nascosto."
...
translate italian simple_displayables_bfe78cb7:
    ...
    e "L'istruzione image serve ad assegnare un nome a un'immagine da visualizzare. Il modo più semplice è semplicemente specificare il nome del file dell'immagine."

# game/indepth_displayables.rpy:29
translate italian simple_displayables_cef4598b:

    # e "But that's not the only thing that an image can refer to. When a string doesn't have a dot in it, Ren'Py interprets that as a reference to a second image."
    e "Ma questa non è l'unica cosa a cui un'immagine può fare riferimento. Quando una stringa non ha un punto, Ren'Py la interpreta come riferimento a una seconda immagine."
...
translate italian simple_displayables_a661fb63:
    ...
    # e "The string can also contain a color code, consisting of hexadecimal digits, just like colors used by web browsers."
    e "La stringa può anche contenere un codice colore, costituito da cifre esadecimali, proprio come i colori usati dai browser web."
...
translate italian simple_displayables_7f2efb23:
    ...
    e "I colori a tre o sei cifre sono opachi, contenenti valori rosso, verde e blu. Le versioni a quattro e otto cifre aggiungono l'alfa, permettendo colori traslucidi."
...
translate italian simple_displayables_9cd108c6:
    ...
    e "Il visualizzabile Transform prende un visualizzabile e può applicargli proprietà di trasformazione."
...
translate italian simple_displayables_f8e1ba3f:
    ...
    e "Nota come, dato che prende un visualizzabile, può prendere un'altra immagine. Infatti, può prendere qualsiasi visualizzabile definito qui."
...
translate italian simple_displayables_c6e39078:
    ...
    e "C'è una forma più completa di Solid, che può accettare proprietà di stile. Questo ci permette di cambiare la dimensione del Solid, dove normalmente riempie lo schermo."
...
translate italian simple_displayables_b102a029:
    ...
    e "Il visualizzabile Text permette a Ren'Py di trattare il testo come se fosse un'immagine."
...
translate italian simple_displayables_0befbee0:
    ...
    e "Questo significa che possiamo applicare altri visualizzabili, come Transform, a Text nello stesso modo in cui lo facciamo con le immagini."
...
translate italian simple_displayables_fcf2325f:
    ...
    e "Il visualizzabile Composite ci permette di raggruppare più visualizzabili insieme in uno solo, dal basso verso l'alto."
...
translate italian simple_displayables_3dc0050e:
    ...
    e "Alcuni visualizzabili sono spesso usati per personalizzare l'interfaccia di Ren'Py, con il visualizzabile Frame che è uno di essi. Il visualizzabile frame prende un altro visualizzabile e la dimensione dei bordi sinistro, superiore, destro e inferiore."
...
translate italian simple_displayables_801b7910:
    ...
    e "Il visualizzabile Frame si espande o si riduce per adattarsi all'area disponibile. Lo fa scalando il centro in due dimensioni e i lati in una, mantenendo gli angoli della stessa dimensione."
...
translate italian simple_displayables_00603985:
    ...
    e "Un Frame può anche affiancare sezioni del visualizzabile fornito, invece di scalarlo."
...
translate italian simple_displayables_d8b23480:
    ...
    e "I Frame possono sembrare un po' strani in astratto, ma quando vengono usati con una texture, puoi vedere come creiamo componenti di interfaccia scalabili."

# game/indepth_displayables.rpy:132
translate italian simple_displayables_ae3f35f5:

    # e "These are just the simplest displayables, the ones you'll use directly most often."
    e "Questi sono solo i visualizzabili più semplici, quelli che userai direttamente più spesso."
...
translate italian simple_displayables_de555a92:
    ...
    e "Puoi anche scrivere visualizzabili personalizzati per i minigiochi, se sei esperto di Python. Ma per molti visual novel, questi saranno tutto ciò di cui avrai bisogno."
