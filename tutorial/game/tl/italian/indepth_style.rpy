...
translate italian strings:
    ...
    new "Questo testo è colorato di verde."
    ...
    new "Questo testo è colorato di rosso."

    # game/indepth_style.rpy:170
    old "This text is colored blue."
    new "Questo testo è colorato di blu."

    # game/indepth_style.rpy:248
    old "Orbiting Earth in the spaceship, I saw how beautiful our planet is.\n–Yuri Gagarin"
    new "Orbitando la Terra nella navicella spaziale, ho visto quanto è bello il nostro pianeta.\n–Jurij Gagarin"

    # game/indepth_style.rpy:303
    old "\"Orbiting Earth in the spaceship, I saw how beautiful our planet is.\" Said by Yuri Gagarin."
    new "\"Orbitando la Terra nella navicella spaziale, ho visto quanto è bello il nostro pianeta.\" Detto da Jurij Gagarin."
    ...
    old "Far better it is to dare mighty things, to win glorious triumphs, even though checkered by failure, than to rank with those poor spirits who neither enjoy nor suffer much, because they live in a gray twilight that knows not victory nor defeat.\n\n–Theodore Roosevelt"
    new "È molto meglio osare grandi cose, vincere trionfi gloriosi, anche se costellati di fallimenti, che classificarsi tra quegli poveri spiriti che non godono né soffrono molto, perché vivono in un crepuscolo grigio che non conosce né vittoria né sconfitta.\n\n–Theodore Roosevelt"

    # game/indepth_style.rpy:561
    old "Top Choice"
    new "Scelta Superiore"

    # game/indepth_style.rpy:566
    old "Bottom Choice"
    new "Scelta Inferiore"
...
translate italian new_gui_17a0326e:
    ...
    e "Quando crei un nuovo progetto, Ren'Py creerà automaticamente una GUI - Interfaccia Grafica Utente - per esso."

# game/indepth_style.rpy:42
translate italian new_gui_12c814ed:

    # e "It defines the look of both in-game interface, like this text box, and out-of-game interface like main and game menus."
    e "Definisce l'aspetto sia dell'interfaccia di gioco, come questa casella di testo, sia dell'interfaccia fuori dal gioco come i menu principali e di gioco."
...
translate italian new_gui_0a2a73bb:
    ...
    e "La GUI predefinita è pensata per essere abbastanza buona per un semplice progetto. Con alcune piccole modifiche, è quello che stai vedendo in questo gioco."

# game/indepth_style.rpy:46
translate italian new_gui_22adf68e:

    # e "The GUI is also meant to be easy for an intermediate creator to customize. Customizing the GUI consists of changing image files in gui directory, and changing variables in gui.rpy."
    e "La GUI è anche pensata per essere facile da personalizzare per un creatore intermedio. Personalizzare la GUI consiste nel cambiare i file immagine nella directory gui e nel cambiare le variabili in gui.rpy."
...
translate italian new_gui_da21de30:
    ...
    e "Allo stesso tempo, anche quando personalizzata, la GUI predefinita potrebbe essere troppo riconoscibile per un gioco estremamente rifinito. Ecco perché l'abbiamo reso facile da sostituire completamente."
...
translate italian new_gui_45765574:
    ...
    e "Abbiamo messo una guida completa per personalizzare la GUI sul sito web di Ren'Py. Quindi se vuoi saperne di più, visita la {a=https://www.renpy.org/doc/html/gui.html}guida alla personalizzazione della GUI{/a}."
...
translate italian styles_fa345a38:
    ...
    e "Ren'Py ha un potente sistema di stili che controlla l'aspetto dei visualizzabili."
...
translate italian styles_6189ee12:
    ...
    e "Sebbene la GUI predefinita usi variabili per fornire stili con valori predefiniti ragionevoli, se stai sostituendo la GUI o creando i tuoi schermi, dovrai imparare gli stili da solo."

# game/indepth_style.rpy:68
translate italian styles_menu_a4a6913e:

    # e "What would you like to know about styles?" nointeract
    e "Cosa vorresti sapere sugli stili?" nointeract
...
translate italian style_basics_9a79ef89:
    ...
    e "Gli stili permettono a un visualizzabile di sembrare diverso da gioco a gioco, o anche all'interno dello stesso gioco."

# game/indepth_style.rpy:103
translate italian style_basics_48777f2c:

    # e "Both of these buttons use the same displayables. But since different styles have been applied, buttons look different from each other."
    e "Entrambi questi pulsanti usano gli stessi visualizzabili. Ma dato che sono stati applicati stili diversi, i pulsanti appaiono diversi l'uno dall'altro."
...
translate italian style_basics_57704d8c:
    ...
    e "Gli stili sono una combinazione di informazioni di quattro diversi luoghi."
...
translate italian style_basics_144731f6:
    ...
    e "Il primo luogo da cui Ren'Py può ottenere informazioni sullo stile è parte di uno schermo. Ogni visualizzabile creato da uno schermo può prendere un nome di stile e proprietà di stile."
...
translate italian style_basics_67e48162:
    ...
    e "Quando un visualizzabile di schermo contiene testo, le proprietà di stile prefissate con text_ si applicano a quel testo."
...
translate italian style_basics_03516b4a:
    ...
    e "Il prossimo è come parte di un visualizzabile creato in un'istruzione image. Le proprietà di stile sono semplicemente argomenti per il visualizzabile."
...
translate italian style_basics_ccc0d1ca:
    ...
    egreen "Le proprietà di stile possono anche essere fornite come argomenti quando si definisce un personaggio."
...
translate italian style_basics_013ab314:
    ...
    egreen "Gli argomenti che iniziano con who_ sono proprietà di stile applicate al nome del personaggio, mentre quelli che iniziano con what_ sono applicati al dialogo del personaggio."
...
translate italian style_basics_dbe80939:
    ...
    egreen "Le proprietà di stile che non hanno un prefisso sono anche applicate al nome del personaggio."

# game/indepth_style.rpy:174
translate italian style_basics_ac6a8414:

    # e "Finally, there is the style statement, which creates or changes a named style. By giving the Text displayable a style argument, we tell it to use the blue_text style." id style_basics_ac6a8414
    e "Infine, c'è l'istruzione style, che crea o modifica uno stile con nome. Dando al visualizzabile Text un argomento style, gli diciamo di usare lo stile blue_text." id style_basics_ac6a8414
...
translate italian style_basics_3d9bdff7:
    ...
    e "Una proprietà di stile può ereditare da un genitore. Se una proprietà di stile non è data in uno stile, proviene dal genitore di quello stile."

# game/indepth_style.rpy:182
translate italian style_basics_49c5fbfe:

    # e "By default, the parent of a style has the same name, with the prefix up to the first underscore removed. If the style does not have an underscore in its name, 'default' is used." id style_basics_49c5fbfe
    e "Per impostazione predefinita, il genitore di uno stile ha lo stesso nome, con il prefisso fino al primo trattino basso rimosso. Se lo stile non ha un trattino basso nel suo nome, viene usato 'default'." id style_basics_49c5fbfe
...
translate italian style_basics_6ab170a3:
    ...
    e "Per esempio, blue_text eredita da text, che a sua volta eredita da default. Lo stile default definisce tutte le proprietà, quindi non eredita da nulla."

# game/indepth_style.rpy:190
translate italian style_basics_f78117a7:

    # e "The parent can be explicitly changed by giving the style statement an 'is' clause. In this case, we're explicitly setting the style to be the parent of text."
    e "Il genitore può essere cambiato esplicitamente dando all'istruzione style una clausola 'is'. In questo caso, stiamo impostando esplicitamente lo stile per essere il genitore di text."
...
translate italian style_basics_6007040b:
    ...
    e "Ogni visualizzabile ha un nome di stile predefinito. Per impostazione predefinita, è solitamente il nome del visualizzabile in minuscolo, come 'text' per Text, o 'button' per i pulsanti."

# game/indepth_style.rpy:196
translate italian style_basics_35db9a05:

    # e "In a screen, a displayable can be given a style_prefix property to give a prefix for that displayable and its children." id style_basics_35db9a05
    e "In uno schermo, a un visualizzabile può essere data una proprietà style_prefix per dare un prefisso a quel visualizzabile e ai suoi figli." id style_basics_35db9a05
...
translate italian style_basics_422a87f7:
    ...
    e "Per esempio, un visualizzabile text con uno style_prefix di 'help' avrà lo stile 'help_text'."
...
translate italian style_basics_bad2e207:
    ...
    e "Infine, quando un visualizzabile è un pulsante, o all'interno di un pulsante, può prendere prefissi di stile."
...
translate italian style_basics_22ed20a1:
    ...
    e "I prefissi idle_, hover_ e insensitive_ sono usati quando il pulsante non è messo a fuoco, è messo a fuoco e non può essere messo a fuoco."
...
translate italian style_basics_7a58037e:
    ...
    e "Questi possono essere preceduti da selected_ per cambiare l'aspetto del pulsante quando rappresenta un valore o schermo selezionato."
...
translate italian style_basics_0cdcb8c3:
    ...
    e "Questo schermo mostra i prefissi di stile in azione. Puoi cliccare su un pulsante per selezionarlo, o cliccare all'esterno per avanzare."
...
translate italian style_basics_aed05094:
    ...
    e "Queste sono le nozioni di base sugli stili. Se la personalizzazione della GUI non basta, gli stili ti permettono di personalizzare praticamente tutto in Ren'Py."
...
translate italian style_general_81f3c8ff:
    ...
    e "Il primo gruppo di proprietà di stile che esamineremo sono le proprietà di stile generali. Queste funzionano con ogni visualizzabile, o almeno molti diversi."
...
translate italian style_general_a8d99699:
    ...
    e "Ogni visualizzabile accetta le proprietà di posizione, che controllano dove può essere posizionato sullo schermo. Dato che le ho già menzionate, non le ripeterò qui."
...
translate italian style_general_58d4a18f:
    ...
    e "Le proprietà xmaximum e ymaximum impostano rispettivamente la larghezza e l'altezza massime del visualizzabile. Questo causerà Ren'Py a rimpicciolire le cose, se possibile."
...
translate italian style_general_cae9a39f:
    ...
    e "A volte, la dimensione rimpicciolita sarà più piccola della dimensione data da xmaximum e ymaximum."

# game/indepth_style.rpy:279
translate italian style_general_5928c24e:

    # e "Similarly, xminimum and yminimum properties set the minimum width and height. If the displayable is smaller, Ren'Py will try to make it bigger."
    e "Allo stesso modo, le proprietà xminimum e yminimum impostano rispettivamente la larghezza e l'altezza minime. Se il visualizzabile è più piccolo, Ren'Py cercherà di renderlo più grande."
...
translate italian style_general_35a8ee5e:
    ...
    e "Le proprietà xsize e ysize impostano la dimensione minima e massima allo stesso valore, fissando la dimensione."

# game/indepth_style.rpy:291
translate italian style_general_fcfb0640:

    # e "These only works for displayables that can be resized. Some displayables, like images, can't be made bigger or smaller."
    e "Questi funzionano solo per visualizzabili che possono essere ridimensionati. Alcuni visualizzabili, come le immagini, non possono essere resi più grandi o più piccoli."

# game/indepth_style.rpy:299
translate italian style_general_cd5cc97c:

    # e "The area property takes a tuple - a parenthesis bounded list of four items. The first two give the position, and the second two give the size."
    e "La proprietà area accetta una tupla - una lista delimitata da parentesi di quattro elementi. I primi due danno la posizione, e i secondi due danno la dimensione."
...
translate italian style_general_e5a58f0b:
    ...
    e "Infine, la proprietà alt cambia il testo usato dalla voce automatica per i non udenti."
...
translate italian style_text_fe457b8f:
    ...
    e "Le proprietà di stile del testo si applicano ai visualizzabili di testo e input."
...
translate italian style_text_7ab53f03:
    ...
    e "I visualizzabili di testo possono essere creati implicitamente o esplicitamente. Per esempio, un textbutton crea un visualizzabile di testo con uno stile che termina in button_text."
...
translate italian style_text_6dd42a57:
    ...
    e "Questi possono anche essere impostati in gui.rpy cambiando o definendo variabili con nomi come gui.button_text_size."
...
translate italian style_text_c689130e:
    ...
    e "La proprietà di stile bold rende il testo in grassetto. Questo può essere fatto usando un algoritmo, piuttosto che una versione diversa del font."
...
translate italian style_text_3420bfe4:
    ...
    e "La proprietà color cambia il colore del testo. Accetta codici colore esadecimali, proprio come tutto il resto in Ren'Py."
...
translate italian style_text_14bd6327:
    ...
    e "La proprietà di stile first_indent determina quanto è rientrata la prima riga."
...
translate italian style_text_779ac517:
    ...
    e "La proprietà di stile font cambia il font usato dal testo. Ren'Py accetta font TrueType e OpenType, e dovrai includere il file font come parte del tuo visual novel."

# game/indepth_style.rpy:379
translate italian style_text_917e2bca:

    # e "The size property changes the size of the text."
    e "La proprietà size cambia la dimensione del testo."
...
translate italian style_text_1a46cd43:
    ...
    e "La proprietà italic rende il testo corsivo. Di nuovo, questo è meglio fatto con un font, ma per brevi quantità di testo Ren'Py può farlo per te."

# game/indepth_style.rpy:397
translate italian style_text_472f382d:

    # e "The justify property makes the text justified, lining all but the last line up on the left and right side."
    e "La proprietà justify rende il testo giustificato, allineando tutte tranne l'ultima riga sui lati sinistro e destro."
...
translate italian style_text_87b075f8:
    ...
    e "La proprietà kerning crena il testo. Quando è negativo, i caratteri sono più vicini. Quando è positivo, i caratteri sono più lontani."
...
translate italian style_text_fe7dec14:
    ...
    e "Le proprietà line_leading e line_spacing mettono rispettivamente spaziatura prima di ogni riga e tra le righe."
...
translate italian style_text_aee9277a:
    ...
    e "La proprietà outlines mette contorni attorno al testo. Questo accetta una lista di tuple, che è un po' complicato."
...
translate italian style_text_b4c5190f:
    ...
    e "Ma se ignori le parentesi quadre e tonde, hai la larghezza del contorno, il colore, e poi gli offset orizzontali e verticali."
...
translate italian style_text_5a0c2c02:
    ...
    e "La proprietà rest_indent controlla il rientro delle righe dopo la prima."
...
translate italian style_text_430c1959:
    ...
    e "La proprietà textalign controlla il posizionamento di più righe di testo all'interno del visualizzabile di testo. Per esempio, 0.5 significa centrato." id style_text_430c1959
...
translate italian style_text_19aa0833:
    ...
    e "Non cambia la posizione del visualizzabile di testo stesso. Per quello, vorrai spesso impostare textalign e xalign allo stesso valore." id style_text_19aa0833
...
translate italian style_text_efc3c392:
    ...
    e "Quando sia textalign che xalign sono impostati a 1.0, il testo è propriamente giustificato a destra." id style_text_efc3c392

# game/indepth_style.rpy:464
translate italian style_text_43be63b9:

    # e "The underline property underlines the text."
    e "La proprietà underline sottolinea il testo."
...
translate italian style_text_343f6d34:
    ...
    e "Queste sono le proprietà di stile del testo più comuni, ma non le sole. Ecco alcune altre che potresti aver bisogno in circostanze speciali."

# game/indepth_style.rpy:479
translate italian style_text_e7204a95:

    # e "By default, text in Ren'Py is antialiased, to smooth out edges. The antialias property can turn that off, and make the text a little more jagged."
    e "Per impostazione predefinita, il testo in Ren'Py è antialiasato, per smussare i bordi. La proprietà antialias può disattivarlo, e rendere il testo un po' più frastagliato."

# game/indepth_style.rpy:487
translate italian style_text_a5316e4c:

    # e "The adjust_spacing property is a very subtle one, that only matters when a player resizes the window. When True, characters will be shifted a bit so that Text has the same relative spacing."
    e "La proprietà adjust_spacing è molto sottile, che importa solo quando un giocatore ridimensiona la finestra. Quando è True, i caratteri saranno spostati un po' affinché Text abbia la stessa spaziatura relativa."
...
translate italian style_text_605d4e4a:
    ...
    e "Quando è False, il testo non salterà tanto. Ma può essere un po' più largo o più stretto in base alla dimensione dello schermo."
...
translate italian style_text_acf8a0e1:
    ...
    e "La proprietà layout ha alcuni valori speciali che controllano dove vengono spezzate le righe. Il valore 'nobreak' disabilita completamente gli a capo, rendendo il testo più largo."
...
translate italian style_text_785729cf:
    ...
    e "Quando la proprietà layout è impostata a 'subtitle', l'algoritmo di spezzatura delle righe viene cambiato per cercare di rendere tutte le righe pari in lunghezza, come solitamente sono i sottotitoli."
...
translate italian style_text_9c26f218:
    ...
    e "La proprietà strikethrough disegna una linea attraverso il testo. Sembra piuttosto improbabile che tu vorrai usare questo."
...
translate italian style_text_c7229243:
    ...
    e "La proprietà vertical pone il testo in un layout verticale. È pensata per le lingue asiatiche con font speciali."
...
translate italian style_text_724bd5e0:
    ...
    e "E questi sono le proprietà di stile del testo. Potrebbero essercene molte, ma vogliamo darti molto controllo su come presenti il testo ai tuoi giocatori."
...
translate italian style_button_300b6af5:
    ...
    e "Prossimamente, abbiamo le proprietà di stile di finestra e pulsante. Queste si applicano alle finestre come la finestra di testo in basso a questo schermo e alle cornici come quelle in cui mostriamo esempi."
...
translate italian style_button_255a18e4:
    ...
    e "Queste proprietà si applicano anche ai pulsanti, dentro e fuori dal gioco. Per Ren'Py, un pulsante è una finestra su cui puoi cliccare."
...
translate italian style_button_9b53ce93:
    ...
    e "Inizierò con questo stile, da cui tutto erediterà. Per semplificarci la vita, eredita dallo stile predefinito, piuttosto che dai pulsanti personalizzati nella GUI di questo gioco." id style_button_9b53ce93
...
translate italian style_button_aece4a8c:
    ...
    e "La prima proprietà di stile è la proprietà background. Aggiunge uno sfondo a un pulsante o finestra. Dato che questo è un pulsante, le varianti idle e hover scelgono sfondi diversi quando messo a fuoco." id style_button_aece4a8c
...
translate italian style_button_b969f04a:
    ...
    e "Centriamo anche i due pulsanti, usando la proprietà di posizione xalign."
...
translate italian style_button_269ae069:
    ...
    e "Abbiamo anche personalizzato lo stile del testo del pulsante, usando questo stile. Centra il testo e lo fa cambiare colore quando ci passa sopra il mouse."
...
translate italian style_button_1009f3e1:
    ...
    e "Senza alcun padding attorno al testo, il pulsante sembra strano. Ren'Py ha proprietà di padding che aggiungono spazio all'interno dello sfondo del pulsante."
...
translate italian style_button_5bdfa45a:
    ...
    e "Più comunemente usate sono le proprietà di stile xpadding e ypadding, che aggiungono lo stesso padding rispettivamente a sinistra e destra, oppure in alto e in basso."

# game/indepth_style.rpy:629
translate italian style_button_81283d42:

    # e "The margin style properties work the same way, except they add space outside of the background. The full set exists: left_margin, right_margin, top_margin, bottom_margin, xmargin, and ymargin."
    e "Le proprietà di stile margin funzionano allo stesso modo, eccetto che aggiungono spazio all'esterno dello sfondo. Esiste l'insieme completo: left_margin, right_margin, top_margin, bottom_margin, xmargin e ymargin."
...
translate italian style_button_0b7aca6b:
    ...
    e "La proprietà di stile size_group accetta una stringa. Ren'Py assicurerà che tutte le finestre o i pulsanti con la stessa stringa size_group siano della stessa dimensione."
...
translate italian style_button_4c6da7d9:
    ...
    e "In alternativa, le proprietà di stile xfill e yfill fanno prendere a un pulsante tutto lo spazio disponibile nelle direzioni orizzontali o verticali."
...
translate italian style_button_fd5338b2:
    ...
    e "La proprietà foreground fornisce un visualizzabile che è posizionato sopra i contenuti e lo sfondo della finestra o del pulsante."
...
translate italian style_button_b8af697c:
    ...
    e "Un modo per usarlo è fornire decorazioni extra a un pulsante che funge da casella di controllo. Un altro sarebbe usarlo con una Frame per fornire una lucentezza lucida che sovrappone i contenuti del pulsante."
...
translate italian style_button_c0b1b62e:
    ...
    e "Ci sono anche alcune proprietà di stile che si applicano solo ai pulsanti. Le proprietà hover_sound e activate_sound riproducono file audio quando un pulsante è rispettivamente messo a fuoco e attivato."
...
translate italian style_button_02fa647e:
    ...
    e "Infine, la proprietà focus_mask si applica ai pulsanti parzialmente trasparenti. Quando è impostata a True, solo le aree del pulsante che non sono trasparenti causano il messaggio a fuoco del pulsante."
...
translate italian style_bar_414d454a:
    ...
    e "Per dimostrare gli stili, lasciami prima mostrare due delle immagini che useremo. Questa è l'immagine che stiamo usando per le parti della barra che sono vuote."
...
translate italian style_bar_9422b7b0:
    ...
    e "E qui c'è cosa usiamo per le parti della barra che sono piene."
...
translate italian style_bar_8ae6a14b:
    ...
    e "Le proprietà di stile left_bar e right_bar, e le loro varianti hover, danno visualizzabili per il lato sinistro e destro della barra. Per impostazione predefinita, il valore è mostrato a sinistra."

# game/indepth_style.rpy:775
translate italian style_bar_7f0f50e5:

    # e "Also by default, both of the left and right displayables are rendered at the full width of the bar, and then cropped to the appropriate size."
    e "Anche per impostazione predefinita, entrambi i visualizzabili sinistro e destro vengono renderizzati alla larghezza completa della barra, e poi ritagliati alla dimensione appropriata."

# game/indepth_style.rpy:777
translate italian style_bar_9ef4f62f:

    # e "We give the bar a ysize property to set how tall it is. We could also give it xsize to choose how wide, but here it's limited by the width of the frame it's in."
    e "Diamo alla barra una proprietà ysize per impostare quanto è alta. Potremmo anche darle xsize per scegliere quanto larga, ma qui è limitata dalla larghezza della cornice in cui si trova."
...
translate italian style_bar_d4c29710:
    ...
    e "Quando la proprietà di stile bar_invert è True, il valore della barra è mostrato sul lato destro della barra. I visualizzabili left_bar e right_bar potrebbero anche dover essere scambiati."
...
translate italian style_bar_cca67222:
    ...
    e "La proprietà di stile bar_resizing causa il ridimensionamento delle immagini della barra per rappresentare il valore, piuttosto che essere renderizzate alla dimensione completa e ritagliate."
...
translate italian style_bar_7d361bac:
    ...
    e "La proprietà di stile thumb fornisce un'immagine thumb, che è posizionata in base al valore della barra. Nel caso di una barra di scorrimento, viene ridimensionata se possibile." id style_bar_7d361bac
...
translate italian style_bar_b6dfb61b:
    ...
    e "Qui, la usiamo con la proprietà di stile base_bar, che imposta entrambe le immagini della barra allo stesso visualizzabile."

# game/indepth_style.rpy:834
translate italian style_bar_996466ad:

    # e "The left_gutter and right_gutter properties set a gutter on the left or right size of the bar. The gutter is the space the bar can't be dragged into, that can be used for borders."
    e "Le proprietà left_gutter e right_gutter impostano un canale sulla dimensione sinistra o destra della barra. Il canale è lo spazio in cui la barra non può essere trascinata, che può essere usato per i bordi."
...
translate italian style_bar_fa41a83c:
    ...
    e "La proprietà di stile bar_vertical mostra una barra orientata verticalmente. Tutte le altre proprietà cambiano nome - left_bar diventa top_bar, mentre right_bar diventa bottom_bar."
...
translate italian style_bar_5d33c5dc:
    ...
    e "Infine, c'è uno stile che non possiamo mostrare qui, ed è unscrollable. Controlla cosa succede quando una barra di scorrimento non può essere mossa affatto."
...
translate italian style_bar_e8e32280:
    ...
    e "Per impostazione predefinita, è mostrato. Ma se unscrollable è 'insensitive', la barra diventa insensibile. Se è 'hide', la barra è nascosta, ma occupa comunque spazio."
...
translate italian style_bar_f1292000:
    ...
    e "Questo è tutto per le proprietà della barra. Usandole, un creatore può personalizzare le barre, le barre di scorrimento e gli slider."
...
translate italian style_box_5fd535f4:
    ...
    e "Il visualizzabile hbox è usato per disporre i suoi figli orizzontalmente. Per impostazione predefinita, non c'è spaziatura tra i figli, quindi si attaccano."
...
translate italian style_box_0111e5dc:
    ...
    e "Allo stesso modo, il visualizzabile vbox è usato per disporre i suoi figli verticalmente. Entrambi supportano proprietà di stile che controllano il posizionamento."
...
translate italian style_box_5a44717b:
    ...
    e "Per rendere ovvia la dimensione del visualizzabile box, aggiungerò un'evidenziazione alla box stessa, e non alla cornice che la contiene."
...
translate italian style_box_239e7a8f:
    ...
    e "Le box supportano le proprietà di stile xfill e yfill. Queste proprietà fanno espandere una box per riempire lo spazio disponibile, piuttosto che lo spazio del figlio più grande."
...
translate italian style_box_e513c946:
    ...
    e "La proprietà di stile spacing accetta un valore in pixel, e aggiunge quell'ammontare di spaziatura tra ogni figlio della box."
...
translate italian style_box_6ae4f94d:
    ...
    e "La proprietà di stile first_spacing è simile, ma aggiunge solo spazio tra il primo e il secondo figlio. Questo è utile quando il primo figlio è un titolo che ha bisogno di una spaziatura diversa."
...
translate italian style_box_0c518d9f:
    ...
    e "La proprietà di stile box_reverse inverte l'ordine delle voci nella box."
...
translate italian style_box_f73c1422:
    ...
    e "Passeremo di nuovo a una box orizzontale per il nostro prossimo esempio."
...
translate italian style_box_285592bb:
    ...
    e "La proprietà di stile box_wrap riempie la box con figli finché non è piena, poi riparte alla riga successiva."
...
translate italian style_box_a7637552:
    ...
    e "Le griglie portano con loro due ulteriori proprietà di stile. Le proprietà xspacing e yspacing controllano rispettivamente la spaziatura nelle direzioni orizzontali e verticali."
...
translate italian style_box_4006f74b:
    ...
    e "Infine, abbiamo il layout fixed. Il layout fixed di solito si espande per riempire tutto lo spazio, e mostra i suoi figli da dietro a davanti."
...
translate italian style_box_4a2866f0:
    ...
    e "Ma naturalmente, abbiamo alcune proprietà di stile che possono cambiare quello."
...
translate italian style_box_66e042c4:
    ...
    e "Quando la proprietà di stile xfit è True, il fixed dispone tutti i suoi figli come se fosse alla dimensione completa, e poi si riduce in larghezza per adattarli. Lo stile yfit funziona allo stesso modo, ma in altezza."

# game/indepth_style.rpy:1070
translate italian style_box_6a593b10:

    # e "The order_reverse style property changes the order in which children are shown. Instead of back-to-front, they're displayed front-to-back."
    e "La proprietà di stile order_reverse cambia l'ordine in cui vengono mostrati i figli. Invece che da dietro a davanti, vengono mostrati da davanti a dietro."
...
translate italian style_inspector_21bc0709:
    ...
    e "A volte è difficile capire quale stile viene usato per un particolare visualizzabile. L'ispezionatore di visualizzabili può aiutare con quello."
...
translate italian style_inspector_243c50f0:
    ...
    e "Per usarlo, posiziona il mouse su una porzione dell'interfaccia utente di Ren'Py e premi shift+I. Questo è I per ispezionatore."
...
translate italian style_inspector_bcbdc396:
    ...
    e "Ren'Py mostrerà una lista di visualizzabili su cui si trova il mouse. Accanto a ciascuno c'è il nome dello stile che quel visualizzabile usa."
...
translate italian style_inspector_d981e5c8:
    ...
    e "Puoi cliccare sul nome dello stile per vedere da dove ottiene le sue proprietà."
...
translate italian style_inspector_ef46b86d:
    ...
    e "Per impostazione predefinita, l'ispezionatore mostra solo elementi di interfaccia come gli schermi, e non le immagini. Digita shift+alt+I se vorresti vedere anche le immagini."
...
translate italian style_inspector_b59c6b69:
    ...
    e "Puoi provare l'ispezionatore proprio ora, passando il mouse sopra questo testo e premendo shift+I."
...
translate italian strings:
    ...
    # game/indepth_style.rpy:70
    old "Style basics."
    new "Nozioni di base sugli stili."

    # game/indepth_style.rpy:73
    old "General style properties."
    new "Proprietà di stile generali."

    # game/indepth_style.rpy:76
    old "Text style properties."
    new "Proprietà di stile del testo."

    # game/indepth_style.rpy:79
    old "Window and Button style properties."
    new "Proprietà di stile di finestra e pulsante."

    # game/indepth_style.rpy:82
    old "Bar style properties."
    new "Proprietà di stile della barra."

    # game/indepth_style.rpy:85
    old "Box, Grid, and Fixed style properties."
    new "Proprietà di stile di Box, Griglia e Fixed."

    # game/indepth_style.rpy:88
    old "The Displayable Inspector."
    new "L'Ispezionatore di Visualizzabili."
