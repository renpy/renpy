...
translate italian demo_minigame_8f14835c:
    ...
    e "Potresti voler mescolare Ren'Py con altre forme di gioco. Ci sono un paio di modi per farlo."

# game/indepth_minigame.rpy:222
translate italian demo_minigame_9b01503e:

    # e "The first is with screen system, which can be used to display data and create button and menu based interfaces."
    e "Il primo è con il sistema di schermi, che può essere usato per visualizzare dati e creare interfacce basate su pulsanti e menu."
...
translate italian demo_minigame_3e601161:
    ...
    e "Gli schermi funzioneranno per molti giochi di simulazione e RPG."
...
translate italian demo_minigame_a92baa6b:
    ...
    e "Quando gli schermi non bastano, puoi scrivere un visualizzabile definito dal creatore per estendere Ren'Py stesso. Un visualizzabile definito dal creatore può elaborare eventi grezzi e disegnare sullo schermo." id demo_minigame_a92baa6b
...
translate italian demo_minigame_a07dbae0:
    ...
    e "Questo rende possibile creare tutti i tipi di minigiochi. Vorresti giocare a pong?"
...
translate italian pong_done_dde7e31a:
    ...
    e "Vorresti giocare di nuovo?" nointeract

# game/indepth_minigame.rpy:268
translate italian pong_done_a21abf38:

    # e "Here's the source code for minigame. It's very complex, and assumes you understand Python well."
    e "Ecco il codice sorgente per il minigioco. È molto complesso e presume che tu capisca bene Python."
...
translate italian pong_done_750092ed:
    ...
    e "Non entrerò nei dettagli qui. Puoi leggere di più su questo nella {a=https://www.renpy.org/doc/html/udd.html}documentazione sui Visualizzabili Definiti dal Creatore{/a}."
...
translate italian pong_done_5781d902:
    ...
    e "I minigiochi possono rendere il tuo visual novel più interessante, ma fai attenzione – non tutti i giocatori di visual novel vogliono essere bravi ai giochi arcade."
...
translate italian pong_done_631325c8:
    ...
    e "Parte del motivo per cui Ren'Py funziona bene è che è destinato a certi tipi di giochi, come i visual novel e le simulazioni di vita."
...
translate italian pong_done_61d60761:
    ...
    e "Più ti allontani da quei giochi, più ti troverai a combattere con Ren'Py. A un certo punto, ha senso considerare altri motori."
...
translate italian pong_done_715c7b12:
    ...
    e "E questo va bene per noi. Saremo sempre qui per te quando crei visual novel."
