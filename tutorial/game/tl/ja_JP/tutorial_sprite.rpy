...
translate ja_JP tutorial_sprite_40df8d5d:
    ...
    e "私の後ろの背景は175個の星で構成されており、それらはいくつかの異なった速度で移動しています。夜空を飛行するエフェクトになります。"

# game/tutorial_sprite.rpy:72
translate ja_JP tutorial_sprite_29c5e523:
