...
translate ja_JP tutorial_video_f34a17f5:
...
translate ja_JP tutorial_video_4aefd413:
...
translate ja_JP tutorial_video_b927d009:
    ...
    e "これを行うには、まず画像を Movie Displayable として宣言しなければなりません。Movie Displayable には size 引数と、画面上のそれぞれの位置プロパティーを使います。"

# game/tutorial_video.rpy:28
translate ja_JP tutorial_video_d4860780:

    # e "Then, we can show the movie displayable, and start the movie playing with a play statement."
    e "そして、Movie Displayable を表示できます。動画の再生を開始するには play ステートメントを使います。"

# game/tutorial_video.rpy:37
translate ja_JP tutorial_video_373e48d8:

    # e "When we no longer want to play the movie, we can stop it, and then hide it."
    e "動画を再生したくなくなったら、stop で停止し、hide で隠せます。"

# game/tutorial_video.rpy:41
translate ja_JP tutorial_video_a66b154c:
