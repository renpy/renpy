...
translate ja_JP demo_transitions_5bbc72fe:
...
translate ja_JP demo_transitions_menu_3caf78d3:
...
translate ja_JP demo_simple_transitions_2b4fbae3:
...
translate ja_JP demo_simple_transitions_4b235ac2:
...
translate ja_JP demo_simple_transitions_af0431ac:
...
translate ja_JP demo_simple_transitions_5b9f711f:
...
translate ja_JP demo_simple_transitions_79816523:
...
translate ja_JP demo_simple_transitions_141bb95d:
...
translate ja_JP demo_simple_transitions_f059f4ae:
...
translate ja_JP demo_simple_transitions_e948905b:
...
translate ja_JP demo_simple_transitions_6a1ae05f:
...
translate ja_JP demo_simple_transitions_bdfcd85a:
...
translate ja_JP demo_simple_transitions_432f7224:

    # e "Motions can also be used as transitions."
    e "動きのあるものもトランジションとして使えます。"

# game/demo_transitions.rpy:118
translate ja_JP demo_simple_transitions_a20cefa7:

    # "..."
    "..."

# game/demo_transitions.rpy:120
translate ja_JP demo_simple_transitions_0fd4d656:

    # "......"
    "......"

# game/demo_transitions.rpy:125
translate ja_JP demo_simple_transitions_fbf11906:

    # e "Hey! Pay attention."
    e "ちょっと！注意しなさいよ。"

# game/demo_transitions.rpy:127
translate ja_JP demo_simple_transitions_51c1c5b8:
...
translate ja_JP demo_simple_transitions_57f19473:
...
translate ja_JP demo_simple_transitions_fce83e12:
...
translate ja_JP demo_simple_transitions_1050b6a4:
...
translate ja_JP demo_simple_transitions_fbb1838e:
...
translate ja_JP demo_simple_transitions_654a7a87:

    # e "Why would you want to do that?"
    e "なぜこれが必要かって？"

# game/demo_transitions.rpy:147
translate ja_JP demo_simple_transitions_3b8c0bce:
...
translate ja_JP demo_simple_transitions_4632f134:

    # e "Anyway, that's it for the simple transitions."
    e "とりあえず、簡単なトランジションについては以上です。"

# game/demo_transitions.rpy:166
translate ja_JP demo_imagedissolve_transitions_2db67018:
...
translate ja_JP demo_imagedissolve_transitions_429f8d03:
...
translate ja_JP demo_imagedissolve_transitions_1ce501b0:
...
translate ja_JP demo_imagedissolve_transitions_ea0413be:
...
translate ja_JP demo_imagedissolve_transitions_12e2e0d0:
...
translate ja_JP demo_imagedissolve_transitions_bbf73d1c:
...
translate ja_JP demo_imagedissolve_transitions_0ab2902d:
...
translate ja_JP demo_imagedissolve_transitions_54aa9bf9:
...
translate ja_JP demo_imagedissolve_transitions_70cfd5ed:
...
translate ja_JP demo_imagedissolve_transitions_6f089276:
...
translate ja_JP demo_imagedissolve_transitions_c0b9d74d:
...
translate ja_JP demo_imagedissolve_transitions_72ba11d4:
...
translate ja_JP demo_imagedissolve_transitions_fc3b3339:
...
translate ja_JP demo_imagedissolve_transitions_4327dca2:
...
translate ja_JP demo_imagedissolve_transitions_3a401ee7:
...
translate ja_JP demo_imagedissolve_transitions_20d9cf6c:
...
translate ja_JP demo_imagedissolve_transitions_906f7800:
...
translate ja_JP demo_imagedissolve_transitions_4b557a29:
...
translate ja_JP demo_imagedissolve_transitions_e16f8d3a:
...
translate ja_JP demo_imagedissolve_transitions_b6dbf68b:
...
translate ja_JP demo_cropmove_transitions_1711a91e:
...
translate ja_JP demo_cropmove_transitions_6d82cfd7:
...
translate ja_JP demo_cropmove_transitions_4427c78c:

    # e "We first have wiperight..."
    e "まず始めは、右にワイプ(wiperight)..."

# game/demo_transitions.rpy:280
translate ja_JP demo_cropmove_transitions_6d1810a1:

    # e "...followed by wipeleft... "
    e "...次は、左にワイプ(wipeleft)..."

# game/demo_transitions.rpy:285
translate ja_JP demo_cropmove_transitions_1dd1c6a1:

    # e "...wipeup..."
    e "...上にワイプ(wipeup)..."

# game/demo_transitions.rpy:290
translate ja_JP demo_cropmove_transitions_0ea0fa83:

    # e "...and wipedown."
    e "...最後に下にワイプ(wipedown)。"

# game/demo_transitions.rpy:292
translate ja_JP demo_cropmove_transitions_c7cb4c16:

    # e "Next, the slides."
    e "次はスライドです。"

# game/demo_transitions.rpy:297
translate ja_JP demo_cropmove_transitions_462a442f:

    # e "Slideright..."
    e "右にスライド(slideright)..."

# game/demo_transitions.rpy:302
translate ja_JP demo_cropmove_transitions_f9a2e523:

    # e "...slideleft..."
    e "...左にスライド(slideleft)..."

# game/demo_transitions.rpy:307
translate ja_JP demo_cropmove_transitions_20ce3e9c:

    # e "...slideup..."
    e "...上にスライド(slideup)..."

# game/demo_transitions.rpy:312
translate ja_JP demo_cropmove_transitions_9e00a7a6:

    # e "and slidedown."
    e "そして下にスライド(slidedown)。"

# game/demo_transitions.rpy:314
translate ja_JP demo_cropmove_transitions_b8a710c1:
...
translate ja_JP demo_movetransition_5edf6007:
...
translate ja_JP demo_movetransition_dc5ccd54:

    # e "And that's all there is."
    e "以上です。"

# game/demo_transitions.rpy:412
translate ja_JP demo_alphadissolve_3efbde9f:
...
translate ja_JP demo_alphadissolve_7c08cf8b:
...
translate ja_JP demo_alphadissolve_068e3e98:
...
translate ja_JP demo_alphadissolve_6a1b6203:
...
translate ja_JP demo_alphadissolve_80a728b6:
