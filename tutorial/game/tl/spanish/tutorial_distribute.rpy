...
translate spanish distribute_7db9b042:

    # e "One thing Ren'Py makes easy is building distributions of your visual novel so you can give it to players."
    e "Una cosa que Ren'Py hace fácil es crear distribuciones de tu novela visual para que puedas dárselas a los jugadores."
...
translate spanish distribute_821be97b:
    ...
    e "Esto puede ser tan simple como hacer clic en el botón Construir, cuando no estás en una Mac."

# game/tutorial_distribute.rpy:16
translate spanish distribute_638f964a:
    ...
    e "Si estás usando una Macintosh, puedes hacer que Ren'Py firme la aplicación Mac, lo que facilita la ejecución de los jugadores. Para habilitar esto, necesita configurar build.mac_identity en options.rpy."

# game/tutorial_distribute.rpy:21
translate spanish distribute_dd1af4dd:

    # e "Ren'Py supports the mobile platforms, Android and iOS. We also support ChromeOS, through its ability to run Android apps."
    e "Ren'Py es compatible con las plataformas móviles, Android y iOS. También soportamos ChromeOS, a través de su capacidad para ejecutar aplicaciones de Android."

# game/tutorial_distribute.rpy:23
translate spanish distribute_0b547b7b:

    # e "These mobile platforms can be a bit more complicated. While Android apps can be built everywhere, iOS requires a Mac."
    e "Estas plataformas móviles pueden ser un poco más complicadas. Si bien las aplicaciones de Android se pueden construir en cualquier lugar, iOS requiere una Mac."
...
translate spanish distribute_f1cbc9d0:
    ...
    e "Gracias a las herramientas de distribución con las que Ren'Py se envía, hay miles de novelas visuales disponibles."
