...
translate spanish screen_displayable_properties_527d4b4e:
    ...
    e "En primer lugar, todos los visualizables del lenguaje de pantalla admiten las propiedades de posición. Cuando el contenedor en el que se puede exhibir lo admite, puedes usar propiedades como 'align', 'anchor', 'pos', etc."
...
translate spanish screen_displayable_properties_da5733d1:
    ...
    e "Le dice a Ren'Py qué visualizables son el fondo de la ventana, 'who' es quién está hablando y 'what' es lo que dice. Se usa para aplicar estilos por 'Character', y ayuda con el modo de avance automático."
...
translate spanish add_displayable_7112a377:
    ...
    e "Hay algunas maneras de referirse a la imagen. Si está en el directorio de imágenes o definido con la sentencia 'image', solo pon el nombre dentro de una cadena entre comillada."
...
translate spanish text_displayable_1ed1a8c2:
    ...
    e "Además de las propiedades comunes que toman todos los visualizables, el texto toma las propiedades de estilo 'text'. Por ejemplo, 'size' establece el tamaño del texto."
...
translate spanish layout_displayables_74de8a66:
    ...
    e "Ambas cajas toman las propiedades de estilo 'box', la más útil de las cuales es el 'spacing', la cantidad de espacio para dejar entre los hijos."
...
translate spanish layout_displayables_bfaaaf9b:
    ...
    e "Al igual que las cajas, la malla utiliza la propiedad de espaciado para especificar el espacio entre las celdas."
...
translate spanish layout_displayables_eff42786:
    ...
    e "Cuando a un visualizable que no sea layout da dos o más hijos, no es necesario crear 'fixed'. Se agrega automáticamente 'fixed', y los hijos se agregan a él."
...
translate spanish window_displayables_de5963e4:
    ...
    e "Tanto 'frame' como 'window' pueden recibir propiedades de estilo 'window', lo que le permite cambiar elementos como el fondo, los márgenes y el relleno alrededor de la ventana."
...
translate spanish button_displayables_220b020d:
    ...
    e "Un botón de texto también toma las propiedades de estilo 'Text', prefijadas con text. Estos se aplican al texto desplegable que crea internamente."
...
translate spanish imagemap_done_ac9631ef:
    ...
    e "La imagen 'idle' se usa para el fondo del 'imagemaps', para los botones 'hotspot' que no están enfocados o seleccionados, y para la parte vacía de una barra desenfocada."
...
translate spanish imagemap_done_ca286729:
    ...
    e "Los 'imagemaps' no se limitan solo a imágenes. Se puede usar cualquier visualizable donde se espera una imagen."
...
translate spanish imagemap_done_5660a6a2:
    ...
    e "Una hotbar toma un objeto 'BarValue' que describe qué tan llena está la barra y el rango de valores que debe mostrar la barra, tal como lo hace una 'bar' y una 'vbar'."
...
translate spanish imagemap_done_10496a29:
    ...
    e "Un patrón útil es definir una pantalla con un 'imagemap' que tiene 'hotspots' que saltan a las 'label' y 'call' usando la sentencia 'screen'."
...
translate spanish imagemap_done_5b5bc5e5:
    ...
    e "Los 'imagemaps' tienen ventajas y desventajas. Por un lado, son fáciles de crear para un diseñador y pueden verse muy bien. Al mismo tiempo, pueden ser difíciles de traducir, y el texto incrustado en las imágenes puede aparecer borroso cuando se escala la ventana."
...
translate spanish viewport_displayables_7c4678ee:
    ...
    e "Al darle al 'viewport' la propiedad 'scrollbars' la rodea con barras de desplazamiento. La propiedad 'scrollbars' puede tomar como valore 'ambos', 'horizontal' y 'vertical'."
...
translate spanish strings:
    ...
    new "Este texto es más ancho que el visor."
