...
translate spanish screens_menu_7f31d730:
    ...
    e "¿Qué te gustaría saber sobre las pantallas?" nointeract

# game/tutorial_screens.rpy:201
translate spanish screens_demo_115a4b8f:
    ...
    e "Las pantallas son cómo creamos la interfaz de usuario en Ren'Py. Con la excepción de imágenes y transiciones, todo lo que ves viene de una pantalla."

# game/tutorial_screens.rpy:203
translate spanish screens_demo_ce100e07:

    # e "When I'm speaking to you, I'm using the 'say' screen. It's responsible for taking dialogue and presenting it to the player."
    e "Cuando te hablo, estoy usando la pantalla 'say'. Es responsable de decir dialogos y presentarlo al jugador."
...
translate spanish screens_demo_31a20e24:
    ...
    e "La entrada de texto usa la pantalla de 'input', el modo NVL usa la pantalla 'nvl', y así sucesivamente."
...
translate spanish screens_demo_27476d11:
    ...
    e "En un proyecto recién creado, todas estas pantallas viven en screens.rpy. Puedes editar ese archivo para cambiarlas."

# game/tutorial_screens.rpy:223
translate spanish screens_demo_a699b1cb:
    ...
    e "Tampoco estás limitado a estas pantallas. En Ren'Py, puedes crear tus propias pantallas y usarlas para la interfaz de tu juego."

# game/tutorial_screens.rpy:230
translate spanish screens_demo_a136e191:

    # e "For example, in an RPG like visual novel, a screen can display the player's statistics."
    e "Por ejemplo, en un RPG como novela visual, una pantalla puede mostrar las estadísticas del jugador."

# game/tutorial_screens.rpy:234
translate spanish screens_demo_1f50f3d3:

    # e "Which reminds me, I should probably heal you."
    e "Lo que me recuerda, probablemente debería curarte."

# game/tutorial_screens.rpy:241
translate spanish screens_demo_8a54de7a:
    ...
    e "Las pantallas complejas pueden ser la base de toda la mecánica del juego. Una pantalla de estadísticas como esta puede ser la base de simuladores de citas y vida."

# game/tutorial_screens.rpy:246
translate spanish screens_demo_62c184f8:
    ...
    e "Si bien las pantallas pueden ser complejas, en realidad son solo el resultado de muchas partes simples que trabajan juntas para hacer algo más grande que todas ellas."
...
translate spanish screens_showing_ae40755c:
    ...
    e "Trabajaré desde adentro hacia afuera para describir las sentencias. Pero primero, te mostraré la pantalla para que puedas verla en acción."
...
translate spanish screens_showing_7626dc8b:
    ...
    e "La pantalla permanecerá mostrada hasta que se oculte."
...
translate spanish screens_showing_b52e420c:
    ...
    e "Como no podemos mostrar el diálogo al mismo tiempo, deberás hacer clic en 'Aceptar' para continuar."
...
translate spanish screens_parameters_106c2a04:
    ...
    e "Cuando se muestra una pantalla, se pueden proporcionar argumentos para cada uno de los parámetros. Los argumentos pueden ser dados por posición o por nombre."

# game/tutorial_screens.rpy:350
translate spanish screens_parameters_12ac92d4:

    # e "Parameters let us change what a screen displays, simply by re-showing it with different arguments."
    e "Los parámetros nos permiten cambiar lo que muestra una pantalla, simplemente volviéndola a mostrar con diferentes argumentos."
...
translate spanish screens_properties_4fcf8af8:
    ...
    e "Cuando muestro b_tag_screen, reemplaza a_tag_screen."
...
translate spanish screens_properties_5d51bd1e:
    ...
    e "Por alguna razón, la etiqueta toma un nombre, y no una expresión. Es demasiado tarde para cambiarlo."
...
translate spanish screens_properties_f7a2c73d:
    ...
    e "De forma predeterminada, una pantalla tiene un zorder de 0. Cuando dos pantallas tienen el mismo número de zorder, la pantalla que se muestra en segundo lugar está más cerca del jugador."
...
translate spanish screens_properties_e6db6d02:
    ...
    e "En este ejemplo, la primera pantalla se usará para dispositivos pequeños como teléfonos, y la otra pantalla se usará para tabletas y computadoras."
...
translate spanish screens_properties_560ca08a:
    ...
    e "Cuando se da el prefijo 'red', el marco obtiene el estilo 'red_frame', y el texto recibe el estilo 'red_text'."

# game/tutorial_screens.rpy:479
translate spanish screens_properties_c7ad3a8e:

    # e "This can save a lot of typing when styling screens with many displayables in them."
    e "Esto puede ahorrar una gran cantidad de escritura al diseñar pantallas con muchos visualizables en ellas."
...
translate spanish screens_control_0e939050:
    ...
    e "La sentencia de python funciona de la misma manera que lo hace en el script. Una sola línea de Python se introduce con un signo de dólar. Esta línea se ejecuta cada vez que la pantalla se actualiza."
...
translate spanish screens_control_ba8f5f13:
    ...
    e "El Python que usas en las pantallas no puede tener efectos secundarios. Eso significa que no puede hacer cosas como cambiar el valor de una variable."

# game/tutorial_screens.rpy:522
translate spanish screens_control_f75fa254:

    # e "The reason for this is that Ren'Py will run a screen, and the Python in it, during screen prediction."
    e "La razón de esto es que Ren'Py ejecutará una pantalla, y Python en ella, durante la predicción de la pantalla."
...
translate spanish screen_use_95a34d3a:
    ...
    e "Tomemos, por ejemplo, esta pantalla, que muestra dos entradas de estadísticas. Ya hay mucha duplicación allí, y si tuviéramos más estadísticas, habría más."
...
translate spanish screen_use_f8d1bf9d:
    ...
    e "Al hacerlo de esta manera, controlamos la cantidad de duplicación y podemos cambiar las estadísticas en un solo lugar."
...
translate spanish screen_use_1ad1f358:
    ...
    e "La pantalla boilerplate se incluye en la primera, y el texto de la primera pantalla se transcluye en la pantalla boilerplate."
