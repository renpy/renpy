...
translate japanese director_e4543d9b:
    ...
    e "キーボードの左側にあるコマンドを押して使用できる、いくつかのツールがあります。"

# game/tutorial_director.rpy:7
translate japanese director_ebf40500:
    ...
    e "Shift+R を押すとオートリロードモードになります。このモードが有効であれば、スクリプトファイルを編集した際にゲームが自動的にリロードされます。"
...
translate japanese director_70a61c1c:
    ...
    e "Shift+D は開発者メニューを開きます。この画面から、これまでに紹介した機能やその他の機能を開けます。"
...
translate japanese director_e253e03b:
    ...
    e "もし不具合が起きても心配しないでください。このチュートリアルを閉じて再起動すれば変更は消えてもとの状態に戻ります。"

# game/tutorial_director.rpy:42
translate japanese director_1cd735bc:

    # e "To get started, let's go back to a blank slate, with no images on the screen."
    e "始めるに当たり、画面に画像の無い、白紙の状態に戻ります。"
...
translate japanese director_3dcc4362:
    ...
    e "背景を追加してみましょう。追加したいところの'+'をクリックしてください。そして、'scene'ステートメントを選択し、画像を指定するために'washington'をクリックします。最後に「追加」をクリックして追加してください。"

# game/tutorial_director.rpy:48
translate japanese director_292d58b5:
    ...
    e "次に、スプライトを追加をます。'+'をクリックし、'show'、'eileen'、'happy'そして「追加」をクリックしてください。"

# game/tutorial_director.rpy:52
translate japanese director_c875c1a7:
    ...
    e "鉛筆のアイコンでステートメントの編集や削除ができます。'(transform)'、'right'をクリックし、「変更」をクリックしてshowステートメントを変更すると、私を右に移動することができます。"
    # TODO 画面中に'(transform)'が表示されません、atの後ろをクリックしていると出ますがボタンをクリックするとバグが出ます

# game/tutorial_director.rpy:54
translate japanese director_4e04a74e:
    ...
    e "最後に、再生・キュー・停止・ボイスステートメントを使用してオーディオを操作することができます。'play'、'music'、'sunflower-slow-drag.ogg'を追加してみてください。"

# game/tutorial_director.rpy:61
translate japanese director_1364b336:

    # l "Finally, I get some more screen time!"
    l "最後に出番が少し増えたわ"

# game/tutorial_director.rpy:69
translate japanese director_c6dd0c81:
    ...
    e "ディレクターで作成した変更は永久です。これらはスクリプトに保存され、ロールバックしたりこのセクションをやり直すことで確認できます。"

# game/tutorial_director.rpy:71
translate japanese director_9d03b14b:
    ...
    e "ですが、このチュートリアルではゲームを再起動したときにリセットされますので、白紙の状態から再度試すことができます。あなた自身のビジュアルノベルではそのようにはなりません。"

# game/tutorial_director.rpy:73
translate japanese director_dbfa07b2:

    # e "I hope these tools make developing your visual novel that much easier."
    e "これらのツールがあなたのビジュアルノベル開発をより容易にしてくれることを願っています。"
