...
translate japanese demo_minigame_9b01503e:
...
translate japanese demo_minigame_3e601161:

    # e "Screens will work for many simulation-style games and RPGs."
    e "スクリーンは多くのシミュレーションゲームやRPGで動作します。"

# game/indepth_minigame.rpy:226
translate japanese demo_minigame_a92baa6b:
...
translate japanese pong_done_750092ed:
    ...
    e "ここでは詳細は説明しません。詳しくは{a=https://ja.renpy.org/doc/html/udd.html}ユーザー定義Displayable{/a}を参照してください。"

# game/indepth_minigame.rpy:274
translate japanese pong_done_5781d902:

    # e "Minigames can spice up your visual novel, but be careful – not every visual novel player wants to be good at arcade games."
    e "ミニゲームはビジュアルノベルのスパイスになれますが、すべてのノベルゲーマーがアーケードゲームを好むわけではないことに気を付けてください。"

# game/indepth_minigame.rpy:276
translate japanese pong_done_631325c8:
    ...
    e "Ren'Pyがよく働く理由の一部は、ビジュアルノベルやシミュレーションゲームのような特定のゲームに対して最適化しているからです。"

# game/indepth_minigame.rpy:278
translate japanese pong_done_61d60761:
    ...
    e "それらのゲームから遠く離れるほど、Ren'Pyと戦わなければならなくなります。その点で、他のエンジンを考慮するのもよいでしょう。"

# game/indepth_minigame.rpy:282
translate japanese pong_done_715c7b12:

    # e "And that's fine with us. We'll always be here for you when you're making visual novels."
    e "それが私達にもよいことです。私達は常にあなたがビジュアルノベルを制作するときに助けとなります。"
