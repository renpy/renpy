...
init:
    ...
    $ library.translations[u'Start Game'] = u'Start Game'
    $ library.translations[u'Continue Game'] = u'Continue Game'
    $ library.translations[u'Preferences'] = u'Preferences'
    $ library.translations[u'Quit'] = u'Quit'
    ...
    $ library.translations[u'Empty Slot.'] = u'Empty Slot.'
    $ library.translations[u'Yes'] = u'Yes'
    $ library.translations[u'No'] = u'No'
    $ library.translations[u'Please click to continue.'] = u'Please click to continue.'
    $ library.translations[u'Are you sure you want to quit?'] = u'Are you sure you want to quit?'
    ...
    $ library.translations[u'Are you sure you want to overwrite your save?'] = u'Are you sure you want to overwrite your save?'
    $ library.translations[u'The error message was:'] = u'The error message was:'
    $ library.translations[u'You may want to try saving in a different slot, or playing for a while and trying again later.'] = u'You may want to try saving in a different slot, or playing for a while and trying again later.'
    $ library.translations[u'Save Failed.'] = u'Save Failed.'
    ...
    $ library.translations[u'Left'] = u'Left'
    $ library.translations[u'Right'] = u'Right'
    $ library.translations[u'Up'] = u'Up'
    $ library.translations[u'Down'] = u'Down'
    ...
    $ library.translations[u'Joystick Configuration'] = u'Joystick Configuration'
