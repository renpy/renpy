...
translate ukrainian strings:
    ...
    new "Мистецтво оригінального персонажа"
    ...
    new "Оригінальний автор "

    # game/screens.rpy:591
    old "mikey (ATP Projects)"
    new "mikey (ATP проєкти)"

    # game/screens.rpy:594
    old "\nMade with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only]"
    new "\nСтворено за допомогою {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only]"
