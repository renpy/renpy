translate danish strings:
    ...
    new "Opdaterede figurillustrationer"
    ...
    new "Oprindelige figurillustrationer"
    ...
    new "Opdaterede baggrundsillustrationer"
    ...
    new "Oprindelige baggrundsillustrationer"
