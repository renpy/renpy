...
translate korean demo_character_2edcd1df:
    ...
    equote "what_prefix 인수와 what_suffix 인수를 캐릭터 객체 넘겨주면 자동적으로 대사의 앞과 뒤에 텍스트를 붙일 수 있어요."


# game/demo_character.rpy:53
translate korean demo_character_3ba649df:


    # equote "This is a lot easier than having to put those quotes in by hand."
    equote "확실히 손으로 전부 입력하는 것보단 간단하죠."


# game/demo_character.rpy:55
translate korean demo_character_48dc5333:


    # equote "We can also use who_prefix and who_suffix to add text to the name of the speaker."
    equote "who_prefix와 who_suffix를 넘겨주면 캐릭터의 이름 부분의 앞과 뒤에도 텍스트를 추가할 수 있어요."


# game/demo_character.rpy:57
translate korean demo_character_77ce5256:
    ...
    e "또, 캐릭터 객체에 인수를 지정해서 캐릭터의 이름, 대사, 그리고 윈도우 그 자체도 커스터마이징할 수 있어요."


# game/demo_character.rpy:59
translate korean demo_character_fceb39fb:


    # eweird "These can really change the look of the game."
    eweird "이런 것들은 게임의 외관을 굉장히 많이 바꿀 수도 있죠."


# game/demo_character.rpy:61
translate korean demo_character_92ae524c:
...
translate korean demo_character_7c80c8fc:
