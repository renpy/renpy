...
translate ukrainian strings:
    ...
    # gui/game/screens.rpy:249
    old "Back"
    new "Назад"

    # gui/game/screens.rpy:250
    old "History"
    new "Історія"
    ...
    new "## Екрани головного меню і меню гри"
    ...
    new "## Гарантує, що будь-який інший екран меню буде замінено."

    # gui/game/screens.rpy:359
    old "## This empty frame darkens the main menu."
    new "## Ця порожня рамка затемнює головне меню."

    # gui/game/screens.rpy:363
    old "## The use statement includes another screen inside this one. The actual contents of the main menu are in the navigation screen."
    new "## Оператор \"use\" включає інший екран усередині цього. Фактичний уміст головного меню знаходиться на екрані навігації."
    ...
    new "## Тут викладено основну загальну структуру екрана меню гри. Він викликається заголовком екрана і показує тло, заголовок і навігацію."
    ...
    new "## Місце для розділу навігації."

    # gui/game/screens.rpy:477
    old "Return"
    new "Повернутися"
    ...
    # gui/game/screens.rpy:552
    old "## This use statement includes the game_menu screen inside this one. The vbox child is then included inside the viewport inside the game_menu screen."
    new "## Цей оператор \"use\" включає екран \"game_menu\" всередину цього екрану. Потім дочірній елемент \"vbox\" включається всередину \"viewport\" всередині екрана \"game_menu\"."
    ...
    # gui/game/screens.rpy:568
    old "Made with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]"
    new "Зроблено з {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]"

    # gui/game/screens.rpy:579
    old "## Load and Save screens"
    new "## Екрани завантаження і збереження"

    # gui/game/screens.rpy:581
    old "## These screens are responsible for letting the player save the game and load it again. Since they share nearly everything in common, both are implemented in terms of a third screen, file_slots."
    new "## Ці екрани дозволяють гравцеві зберегти гру та завантажити її знову. Оскільки вони мають майже все спільне, обидва реалізовані у термінах третього екрана, \"file_slots\"."
    ...
    new "## Гарантує, що введення отримає подію входу раніше, ніж будь-яка кнопка."
    ...
    # gui/game/screens.rpy:756
    old "After Choices"
    new "Після виборів"

    # gui/game/screens.rpy:757
    old "Transitions"
    new "Переходи"

    # gui/game/screens.rpy:759
    old "## Additional vboxes of type \"radio_pref\" or \"check_pref\" can be added here, to add additional creator-defined preferences."
    new "## Сюди можна додати додаткові vbox'и з типом \"radio_pref\" або \"check_pref\", щоб додати додаткові налаштування, визначені автором."

    # gui/game/screens.rpy:770
    old "Text Speed"
    new "Швидкість друку тексту"

    # gui/game/screens.rpy:774
    old "Auto-Forward Time"
    new "Швидкість авто. переходу"

    # gui/game/screens.rpy:781
    old "Music Volume"
    new "Гучність музики"

    # gui/game/screens.rpy:788
    old "Sound Volume"
    ...
    # gui/game/screens.rpy:809
    old "Mute All"
    new "Без звуку"

    # gui/game/screens.rpy:885
    old "## History screen"
    new "## Екран історії"

    # gui/game/screens.rpy:887
    old "## This is a screen that displays the dialogue history to the player. While there isn't anything special about this screen, it does have to access the dialogue history stored in _history_list."
    new "## Цей екран показує історію діалогів для гравця. Хоч у цьому екрані немає нічого особливого, він повинен мати доступ до історії діалогів, що зберігається в \"_history_list\"."

    # gui/game/screens.rpy:891
    old "## https://www.renpy.org/doc/html/history.html"
    new "## https://www.renpy.org/doc/html/history.html"

    # gui/game/screens.rpy:897
    old "## Avoid predicting this screen, as it can be very large."
    new "## Уникання прогнозування цього екрану, оскільки він може бути дуже великим."
    ...
    # gui/game/screens.rpy:927
    old "The dialogue history is empty."
    new "Історія діалогу порожня."

    # gui/game/screens.rpy:930
    old "## This determines what tags are allowed to be displayed on the history screen."
    new "## Визначає, які позначки дозволено показувати на екрані історії."

    # gui/game/screens.rpy:975
    old "## Help screen"
    new "## Екран довідки"

    # gui/game/screens.rpy:977
    old "## A screen that gives information about key and mouse bindings. It uses other screens (keyboard_help, mouse_help, and gamepad_help) to display the actual help."
    new "## Цей екран надає інформацію про призначення клавіш і миші. Він використовує інші екрани (\"keyboard_help\", \"mouse_help\" та \"gamepad_help\"), щоб показати саму довідку."

    # gui/game/screens.rpy:996
    old "Keyboard"
    new "Клавіатура"

    # gui/game/screens.rpy:997
    old "Mouse"
    new "Миша"
    ...
    new "Відкотує до попереднього діалогу."
    ...
    new "Переносить до наступного діалогу."

    # gui/game/screens.rpy:1046
    old "Hides the user interface."
    new "Приховує інтерфейс."
    ...
    # gui/game/screens.rpy:1107
    old "Y/Top Button"
    new "Кнопка Y/Угору"

    # gui/game/screens.rpy:1110
    old "Calibrate"
    new "Відкалібрувати"
    ...
    # gui/game/screens.rpy:1151
    old "## Ensure other screens do not get input while this screen is displayed."
    new "## Не допускати введення даних на інших екранах під час показу цього екрана."

    # gui/game/screens.rpy:1175
    old "Yes"
    new "Так"

    # gui/game/screens.rpy:1176
    old "No"
    new "Ні"

    # gui/game/screens.rpy:1178
    old "## Right-click and escape answer \"no\"."
    new "## Клацніть ПКМ і виберіть «Ні»."

    # gui/game/screens.rpy:1205
    old "## Skip indicator screen"
    new "## Екран індикатора пропуску"

    # gui/game/screens.rpy:1207
    old "## The skip_indicator screen is displayed to indicate that skipping is in progress."
    new "## Екран \"skip_indicator\" показується, щоб вказати, що відбувається пропуск."

    # gui/game/screens.rpy:1210
    old "## https://www.renpy.org/doc/html/screen_special.html#skip-indicator"
    new "## https://www.renpy.org/doc/html/screen_special.html#skip-indicator"

    # gui/game/screens.rpy:1222
    old "Skipping"
    new "Пропуск"

    # gui/game/screens.rpy:1229
    old "## This transform is used to blink the arrows one after another."
    new "## Ця трансформація використовується для блимання стрілок одна за одною."

    # gui/game/screens.rpy:1256
    old "## We have to use a font that has the BLACK RIGHT-POINTING SMALL TRIANGLE glyph in it."
    new "## Ми маємо використовувати шрифт, в якому є гліф ЧОРНИЙ СПРЯМОВАНИЙ ВПРАВО ТРИКУТНИК."

    # gui/game/screens.rpy:1261
    old "## Notify screen"
    new "## Екран сповіщення"

    # gui/game/screens.rpy:1263
    old "## The notify screen is used to show the player a message. (For example, when the game is quicksaved or a screenshot has been taken.)"
    new "## Екран сповіщення використовується для показу гравцеві повідомлення. (Наприклад, коли гру швидко збережено або зроблено знімок екрана.)"

    # gui/game/screens.rpy:1266
    ...
    # gui/game/screens.rpy:1302
    old "## This screen is used for NVL-mode dialogue and menus."
    new "## Цей екран використовується для меню і діалогу режиму NVL."

    # gui/game/screens.rpy:1304
    old "## https://www.renpy.org/doc/html/screen_special.html#nvl"
    new "## https://www.renpy.org/doc/html/screen_special.html#nvl"

    # gui/game/screens.rpy:1315
    old "## Displays dialogue in either a vpgrid or the vbox."
    new "## Показує діалог як \"vpgrid\" або \"vbox\"."

    # gui/game/screens.rpy:1328
    old "## Displays the menu, if given. The menu may be displayed incorrectly if config.narrator_menu is set to True."
    new "## Показує меню, якщо вказано. Меню може показуватися неправильно, якщо значення \"config.narrator_menu\" задано на \"True\"."

    # gui/game/screens.rpy:1358
    old "## This controls the maximum number of NVL-mode entries that can be displayed at once."
    new "## Цей параметр визначає максимальну кількість рядків у режимі NVL, які можуть бути показані одночасно."

    # gui/game/screens.rpy:1418
    old "## Bubble screen"
    new "## Екран бульбашок"

    # gui/game/screens.rpy:1420
    old "## The bubble screen is used to display dialogue to the player when using speech bubbles. The bubble screen takes the same parameters as the say screen, must create a displayable with the id of \"what\", and can create displayables with the \"namebox\", \"who\", and \"window\" ids."
    new "## Екран бульбашок використовується для показу діалогу гравцеві під час використання мовних бульбашок. Екран бульбашок має ті самі параметри, що й екран промови, має створювати об’єкт з ідентифікатором \"what\", а також може створювати об’єкти з ідентифікаторами \"namebox\", \"who\" та \"window\"."

    # gui/game/screens.rpy:1425
    old "## https://www.renpy.org/doc/html/bubble.html#bubble-screen"
    new "## https://www.renpy.org/doc/html/bubble.html#bubble-screen"

    # gui/game/screens.rpy:1513
    old "## Mobile Variants"
    new "## Мобільні варіанти"

    # gui/game/screens.rpy:1520
