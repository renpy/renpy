...
translate ukrainian strings:
    ...
    new "Переглядач постійних змінних"
    ...
    new "    (трасформації: [', '.join(transform_list)])"
    ...
    new "Прямокутник скопійовано до буфера обміну."

    # renpy/common/_developer/developer.rpym:370
    old "Position copied to clipboard."
    new "Позицію скопійовано до буфера обміну."
    ...
    new "ПКМ або ESC для виходу."

    # renpy/common/_developer/developer.rpym:440
    old "Type to filter: "
    new "Введіть для фільтрування: "
