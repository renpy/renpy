...
translate ukrainian strings:
    ...
    new "Спробує імітувати телевізійну приставку на базі Android.\n\nВведення з контролера прив’язане до клавіш зі стрілками, Enter прив’язаний до кнопки вибору, Escape прив’язаний до кнопки меню, а PageUp прив’язаний до кнопки «Назад»."
    ...
    new "Ren'Py запускається з теки, доступної лише для зчитування. Деякі функції не працюватимуть."
    ...
    new "Тека game/libs/ призначена для сторонніх бібліотек, які потрібно розмістити в game/libs.\n\nЯкщо цей файл (game/libs/libs.txt) присутній, Ren'Py завантажить усі файли\nв теці libs перед будь-якими іншими файлами в теці game/ і проігнорує першу назву теки\nв теці game/libs під час визначення порядку завантаження файлів.\n"
