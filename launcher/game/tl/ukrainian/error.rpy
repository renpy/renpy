...
translate ukrainian strings:
    ...
    new "Ця гра вимагає використання GL2, який не може бути ініціалізовано."

    # renpy/common/00gltest.rpy:216
    old "This computer has a problem displaying graphics: [problem]."
    new "Цей пристрій має проблему з показом графіки: [problem]"

    # renpy/common/00gltest.rpy:220
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Графічні драйвери можуть бути застарілими або працювати неправильно. Це може призвести до повільного або некоректного показу графіки."
    ...
    new "Змінити параметри візуалізатора"

    # renpy/common/00gamepad.rpy:33
    old "Select Gamepad to Calibrate"
    new "Виберіть ґеймпад для калібрування"
