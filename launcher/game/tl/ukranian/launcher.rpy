...
translate ukrainian strings:
    ...
    new "# Ren'Py автоматично завантажує всі файли сценаріїв із розширенням .rpy. Щоб використовувати цей\n# файл, визначте мітку та перейдіть до неї з іншого файлу.\n"
    ...
    new "Поточний проект не налаштовано. Використовуйте \"Налаштувати\", щоб налаштувати його перед створенням."
    ...
    new "Виберіть \"Створити\", щоб створити поточний проект, або приєднайте пристрій Android і виберіть \"Створити та встановити\", щоб створити та встановити його на пристрої."
    ...
    new "Налаштовує назву пакета, версію та іншу інформацію про цей проект."
    ...
    new "Андроід: [project.current.display_name!q]"
    ...
    old "Build & Install"
    new "Збірка та Запуск"

    # game/android.rpy:421
    old "Build, Install & Launch"
    new "Збірка, Встановлення та Запуск"
    ...
    new "Якщо підтримується, це можна знайти в «Параметрах розробника», «Налагодження бездротового зв’язку», «З’єднати пристрій із кодом з’єднання»."
    ...
    new "Виберіть Каталог проектів"

    # game/choose_directory.rpy:79
    old "The selected projects directory is not writable."
    new "Вибраний каталог проектів не доступний для запису."
    ...
    new "{b}Warning{/b}\nЯкщо продовжити, буде перезаписано налаштоване зображення панелі, кнопки, слота для збереження, смуги прокрутки та повзунка.\n\nЩо ви хочете зробити?"
    ...
    new "Своє. GUI користувача оптимізовано для співвідношення сторін 16:9."
    ...
    new "Цей екран дозволяє інсталювати бібліотеки, що неможлоиво поширити за допомогою Ren'Py. Деякі з цих бібліотек можуть вимагати від вас підтвердити ліцензію третьої сторони перед використанням або розповсюдженням."
    ...
    new "{a=https://www.live2d.com/en/download/cubism-sdk/download-native/}Cubism SDK for Native{/a} додає підтримку відображення моделей Live2D. Помістіть CubismSdkForNative-4-{i}version{/i}.zip у каталог Ren'Py SDK і натисніть «Установити». Розповсюдження гри за допомогою Live2D вимагає від вас прийняти ліцензію від Live2D, Inc."

    # game/install.rpy:189
    old "Live2D in Ren'Py doesn't support the Web, Android x86_64 (including emulators and Chrome OS), and must be added to iOS projects manually. Live2D must be reinstalled after upgrading Ren'Py or installing Android support."
    new "Live2D у Ren'Py не підтримує Інтернет, Android x86_64 (включаючи емулятори та ОС Chrome), і його потрібно додавати до проектів iOS вручну. Live2D необхідно перевстановити після оновлення Ren'Py або встановлення підтримки Android."
    ...
    new "Інфо про спонсора Ren'Py"

    # game/interface.rpy:269
    old "Due to package format limitations, non-ASCII file and directory names are not allowed."
    new "Через обмеження формату пакунків імена файлів і каталогів, відмінні від ASCII, заборонені."
    ...
    new "Каталог, у якому будуть розміщені проекти Xcode, не вибрано. Виберіть «Вибрати каталог», щоб вибрати його."

    # game/ios.rpy:30
    old "There is no Xcode project corresponding to the current Ren'Py project. Choose 'Create Xcode Project' to create one."
    new "Немає проекту Xcode, який би відповідав поточному проекту Ren'Py. Виберіть «Створити проект Xcode», щоб створити його."
    ...
    new "Проект Xcode існує. Виберіть «Оновити проект Xcode», щоб оновити його останніми файлами гри, або скористайтеся Xcode, щоб створити та встановити його."
    ...
    new "Вибирає каталог, де будуть розміщені проекти Xcode."

    # game/ios.rpy:37
    old "Creates an Xcode project corresponding to the current Ren'Py project."
    new "Створює проект Xcode, що відповідає поточному проекту Ren'Py."

    # game/ios.rpy:38
    old "Updates the Xcode project with the latest game files. This must be done each time the Ren'Py project changes."
    new "Оновіть проект Xcode останніми файлами гри. Це потрібно робити щоразу, коли змінюється проект Ren'Py."

    # game/ios.rpy:39
    old "Opens the Xcode project in Xcode."
    new "Відкриває проект Xcode у Xcode."

    # game/ios.rpy:41
    old "Opens the directory containing Xcode projects."
    new "Відкриває каталог, що містить проекти Xcode."

    # game/ios.rpy:139
    old "The Xcode project already exists. Would you like to rename the old project, and replace it with a new one?"
    new "Проект Xcode вже існує. Бажаєте перейменувати старий проект і замінити його новим?"
    ...
    new "Виберіть каталог проектів Xcode"

    # game/ios.rpy:326
    old "Create Xcode Project"
    new "Створіть проект Xcode"

    # game/ios.rpy:330
    old "Update Xcode Project"
    new "Оновіть проект Xcode"

    # game/ios.rpy:335
    old "Launch Xcode"
    new "Завантаження Xcode"

    # game/ios.rpy:358
    old "Open Xcode Projects Directory"
    new "Відкрийте каталог проектів Xcode"
    ...
    new "КАТАЛОГ ПРОЕКТІВ XCODE"

    # game/ios.rpy:404
    old "Please choose the Xcode Projects Directory using the directory chooser.\n{b}The directory chooser may have opened behind this window.{/b}"
    new "Виберіть каталог проектів Xcode за допомогою засобу вибору каталогу.\n{b}Можливо, засіб вибору каталогу відкрився за цим вікном.{/b}"

    # game/ios.rpy:409
    old "Ren'Py has set the Xcode Projects Directory to:"
    new "Ren'Py встановив каталог проектів Xcode на:"
    ...
    new "Збудовані дистрибутиви не знайдено. Виберіть «Створити» та повторіть спробу."
    ...
    new "Установіть програму itch.io, яка включає батлер, і повторіть спробу."

    # game/itch.rpy:144
    old "The name of the itch project has not been set."
    new "Назва проекту itch не встановлена."

    # game/itch.rpy:144
    old "Please {a=https://itch.io/game/new}create your project{/a}, then add a line like \n{vspace=5}define build.itch_project = \"user-name/game-name\"\n{vspace=5} to options.rpy."
    new "Будь ласка {a=https://itch.io/game/new}створіть свій проект{/a}, а потім додайте рядок на зразок \n{vspace=5}define build.itch_project = \"user-name/game-name \"\n{vspace=5} до options.rpy."
    ...
    new "Не знайдено коментарів TODO.\in\Щоб створити його, додайте \"# TODO\" у свій скрипт."
    ...
    new "Не вдалося встановити каталог проектів. Здаватися."
    ...
    new "Ви створюватимете мовний проект [new_project_language]{#this substitution may be localized}. Змініть мову програми запуску в налаштуваннях, щоб створити проект іншою мовою."
    ...
    new "Будь ласка, введіть назву вашого проекту:"

    # game/new_project.rpy:96
    old "The project name may not be empty."
    new "Назва проекту не може бути пустою."

    # game/new_project.rpy:102
    old "[project_name!q] already exists. Please choose a different project name."
    new "[project_name!q] вже існує. Виберіть іншу назву проекту."

    # game/new_project.rpy:106
    old "[project_dir!q] already exists. Please choose a different project name."
    new "[project_dir!q] вже існує. Виберіть іншу назву проекту."

    # game/new_project.rpy:124
    old "Choose Project Template"
    new "Виберіть Шаблон проекту"
    ...
    new "Включає приватні назви"

    # game/preferences.rpy:205
    old "Include library names"
    new "Включає бібліотечні назви"
    ...
    new "Інформацію про створення спеціальної теми можна знайти {a=https://www.renpy.org/doc/html/skins.html}у документації Ren'Py{/a}."
    ...
    new "{#in language font}Почніть використовувати Ren'Py мовою [lang_name]"

    # game/project.rpy:46
    old "After making changes to the script, press shift+R to reload your game."
    new "Після внесення змін до сценарію натисніть shift+R, щоб перезавантажити гру."
    ...
    new "Ви нещодавно створювали резервні копії своїх проектів?"

    # game/project.rpy:280
    old "Launching the project failed."
    new "Невдалий запуск проекту."

    # game/project.rpy:280
    old "This may be because the project is not writeable."
    new "Це може статися, бо проект не записаний."

    # game/project.rpy:282
    old "Please ensure that your project launches normally before running this command."
    new "Перед виконанням цієї команди переконайтеся, що ваш проект запускається нормально."

    # game/project.rpy:298
    old "Ren'Py is scanning the project..."
    new "Ren'Py сканує проект..."
    ...
    old "PROJECTS DIRECTORY"
    new "РОЗТАШУВАННЯ ПРОЕКТІВ"

    # game/project.rpy:794
    old "Please choose the projects directory using the directory chooser.\n{b}The directory chooser may have opened behind this window.{/b}"
    new "Виберіть каталог проектів за допомогою засобу вибору каталогу.\n{b}Можливо, засіб вибору каталогу відкрився за цим вікном.{/b}"

    # game/project.rpy:794
    old "This launcher will scan for projects in this directory, will create new projects in this directory, and will place built projects into this directory."
    new "Цей лаунчер скануватиме проекти в цьому каталозі, створюватиме нові проекти в цьому каталозі та розміщуватиме вбудовані проекти в цей каталог."

    # game/project.rpy:799
    old "Ren'Py has set the projects directory to:"
    new "Ren'Py встановив каталог проектів на:"
    ...
    new "Створення порожніх рядків для перекладів"
    ...
    new "Оновити переклади інтерфейсу за умовчанням"

    # game/translations.rpy:228
    old "The extract command allows you to extract string translations from an existing project into a temporary file.\n\nThe merge command merges extracted translations into another project."
    new "Команда extract дозволяє витягувати переклади рядків із існуючого проекту в тимчасовий file.\n\nКоманда merge об’єднує витягнуті переклади в інший проект."
    ...
    new "Ren'Py завершив вилучення перекладів рядків [language]."
    ...
    new "Ren'Py завершив об’єднання перекладів рядків [language]."
    ...
    new "Видаляйте текстові теги з діалогу."

    # game/translations.rpy:381
    old "Escape quotes and other special characters."
    new "Екранування лапок та інших спеціальних символів."

    # game/translations.rpy:382
    old "Extract all translatable strings, not just dialogue."
    new "Витягніть усі рядки, які можна перекладати, а не лише діалоги."
    ...
    new "Ren'Py завершив вилучення діалогу. Роздобуте діалогове вікно можна знайти в діалозі [persistent.dialogue_format] у базовому каталозі."
    ...
    new "Попередній перегляд наступної версії Ren'Py, яку можна використовувати для тестування та використання нових функцій, але не для остаточних випусків ігор."
    ...
    new "Створення веб-додатку"

    # game/web.rpy:308
    old "Build and Open in Browser"
    new "Створення та відкриття в браузері"
    ...
    new "Поточні обмеження веб-платформи означають, що завантаження великих зображень може призвести до збоїв звуку чи частоти кадрів і зниження продуктивності загалом. Фільми не підтримуються."
