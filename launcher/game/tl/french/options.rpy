translate french strings:
    ...
    # options.rpy:196
    old '## A Google Play license key is required to download expansion files and perform in-app purchases. It can be found in the Google Play developer console, under "Monetize" > "Monetization Setup" > "Licensing".'
    new '## Une clé de licence A Google Play est requise pour télécharger les fichiers et permettre les achats dans l'application. Vous pourrez la trouver dans la console de développement Google Play, sous "Monétiser" > "Configuration de la monétisation" > "Licences".'
