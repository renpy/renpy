translate schinese strings:
    ...
    # game/web.rpy:336
    old "Current limitations in the web platform mean that loading large images may cause audio or framerate glitches, and lower performance in general. Movies have limited support."
    new "目前网络平台的限制意味着加载大型图像可能会导致音频或帧数故障，并降低总体性能。对视频的支持有限。"
